...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(augusta_dir);
...
pub fn secret_file_path(augusta_dir: &Path) -> PathBuf {
    augusta_dir.join(OTP_SECRET_FILE)
}
