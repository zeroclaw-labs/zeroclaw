...
pub use quantclaw_runtime::skills::*;

use anyhow::{Context, Result};
use std::path::PathBuf;
pub mod creator {
    #[allow(unused_imports)]
    pub use quantclaw_runtime::skills::creator::*;
}
pub mod audit {
    #[allow(unused_imports)]
    pub use quantclaw_runtime::skills::audit::*;
}
pub mod skill_tool {
    #[allow(unused_imports)]
    pub use quantclaw_runtime::skills::skill_tool::*;
}
pub mod skill_http {
    #[allow(unused_imports)]
    pub use quantclaw_runtime::skills::skill_http::*;
}
    ...
    match command {
        crate::SkillCommands::List => {
            ...
            if skills.is_empty() {
                ...
                println!();
                println!("  Create one: mkdir -p ~/.quantclaw/workspace/skills/my-skill");
                println!(
                    "              echo '# My Skill' > ~/.quantclaw/workspace/skills/my-skill/SKILL.md"
                );
                println!();
                println!("  Or install: quantclaw skills install <source>");
            } else {
