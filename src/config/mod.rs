...
pub use schema::{
    ...
    OtpConfig, OtpMethod, PeripheralBoardConfig, PeripheralsConfig, PluginLimitsConfig,
    PluginsConfig, ProxyConfig, ProxyScope, QueryClassificationConfig, ReliabilityConfig,
