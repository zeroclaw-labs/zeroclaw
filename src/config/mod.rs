...
pub use schema::{
    ...
    PeripheralsConfig, PerplexityFilterConfig, PluginEntryConfig, PluginsConfig,
    ...
    QuietHoursWindow, RecoveryConfig, ReliabilityConfig, ResearchPhaseConfig, ResearchTrigger,
