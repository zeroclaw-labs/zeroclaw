...
pub use schema::{
    ...
    HttpRequestConfig, IMessageConfig, IdentityConfig, ImageGenConfig, ImageGenProviderType,
    ...
    PluginsConfig, PostgresMemoryConfig, ProjectIntelConfig, ProxyConfig, ProxyScope, QdrantConfig,
