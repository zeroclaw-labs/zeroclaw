...
pub use schema::{
    ...
    IMessageConfig, IdentityConfig, KnowledgeConfig, LarkConfig, LinkedInConfig,
    LinkedInContentConfig, MatrixConfig, McpConfig, McpServerConfig, McpTransport, MemoryConfig,
