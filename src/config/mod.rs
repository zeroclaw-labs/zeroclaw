...
pub use schema::{
    ...
    StorageProviderSection, StreamMode, TelegramConfig, ToolsInjectionMode, TranscriptionConfig,
    TtsConfig, TunnelConfig, WebFetchConfig, WebSearchConfig, WebhookConfig,
};
