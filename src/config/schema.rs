...
pub struct Config {
    ...
    ///
    /// We omit the section when it matches the default (disabled) state, to
    /// avoid user confusion over an undocumented / experimental section.
...
impl ConversationalAiConfig {
    ...
    /// Returns `true` when the conversational AI feature is disabled.
