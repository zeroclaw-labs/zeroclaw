...
const SNAPSHOT_HEADER: &str = "# 🧠 JhedaiClaw Memory Snapshot\n\n\
    > Auto-generated by JhedaiClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 JhedaiClaw Memory Snapshot

> Auto-generated by JhedaiClaw.
...
I am JhedaiClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 JhedaiClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
