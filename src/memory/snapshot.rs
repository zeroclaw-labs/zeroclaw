...
const SNAPSHOT_HEADER: &str = "# 🧠 Augusta Memory Snapshot\n\n\
    > Auto-generated by Augusta. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Augusta Memory Snapshot

> Auto-generated by Augusta.
...
I am Augusta, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Augusta Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
