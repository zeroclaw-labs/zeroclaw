...
pub async fn run_gateway(host: &str, port: u16, config: Config) -> Result<()> {
    ...
    // BlueBubbles channel not available (removed)
    ...
    let base_observer = crate::observability::create_observer(&config.observability);
    ...
    // OpenAI-compatible endpoints would go here when implemented
...
/*
/// POST /github — incoming GitHub webhook (issue/PR comments) (DISABLED - channel not available)
...
/*
/// POST /bluebubbles — incoming BlueBubbles iMessage webhook (DISABLED - channel not available)
...
Reminder set successfully."#;
    ...
    // Disabled: handle_github_webhook is private and not accessible from test module
    // #[tokio::test]
