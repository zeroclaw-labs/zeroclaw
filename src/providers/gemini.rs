...
use crate::providers::traits::{ChatMessage, ChatRequest, ChatResponse, Provider, TokenUsage, ToolsPayload};
...
impl Provider for GeminiProvider {
    ...
    async fn chat(
        ...
        // If tools are provided, inject tool instructions into system prompt
        // (Gemini uses prompt-guided tools, not native tool calling).
