...
pub fn all_tools_with_runtime(
    ...
    if root_config.web_search.enabled {
        tool_arcs.push(Arc::new(WebSearchTool::new_with_config(
            ...
            root_config.web_search.searxng_auth_token.clone(),
            Some(root_config.web_search.searxng_language.clone()),
            Some(root_config.web_search.searxng_engines.clone()),
            Some(root_config.web_search.searxng_safesearch as usize),
            Some(root_config.web_search.searxng_max_retries),
