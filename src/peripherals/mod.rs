...
pub use quantclaw_hardware::peripherals::*;
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: quantclaw peripheral add <board> <path>");
                println!("  Example: quantclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
