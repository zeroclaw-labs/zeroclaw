...
| NanoBot | External Python lightweight assistant inspired by OpenClaw, useful as another comparison point for minimal assistant runtimes. | NanoBot is related comparison context only. Current ZeroClaw docs do not define a NanoClaw compatibility target. | [NanoBot repository](https://github.com/HKUDS/nanobot) |
