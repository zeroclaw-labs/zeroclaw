...
4. **KiloCLI / Gemini CLI / Grok Build CLI paths**: `[providers.models.kilocli.<alias>] binary_path`, `[providers.models.gemini_cli.<alias>] binary_path`, and `[providers.models.grok_cli.<alias>] binary_path`.
