...
- [Peripherals design](./hardware-peripherals-design.md): the subsystem architecture.
- [Arduino Uno Q](./arduino-uno-q-setup.md), [STM32 Nucleo](./nucleo-setup.md), [Android](./android-setup.md), [Raspberry Pi](./raspberry-pi-setup.md): per-board setup guides.
