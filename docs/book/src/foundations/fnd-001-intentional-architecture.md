...
| 6 | 2026-07-01 | Removed the desktop installer from the release-artifact matrix, target architecture, roadmap, and success criteria ([#8544](https://github.com/zeroclaw-labs/zeroclaw/pull/8544)) |
