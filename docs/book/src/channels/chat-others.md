...
SMS over Twilio, Plivo, Telnyx, Sinch, and Vonage has its own reference page.
See [SMS (Twilio, Plivo, Telnyx, Sinch, Vonage)](./sms.md) for full config,
outbound endpoints, webhook paths, and signature schemes.
