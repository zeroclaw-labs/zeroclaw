...
|---|---|---|
| New provider | [Architecture overview](../architecture/overview.md), [Crates](../architecture/crates.md), [Custom providers](../providers/custom.md), [Provider configuration](../providers/configuration.md) | Providers are edge adapters behind the provider trait, with config and factory wiring. |
| Provider profile selection, model routes, session overrides, runtime model switching, retry, fallback, or provider attribution | [Provider routing lifecycle](../architecture/provider-routing-lifecycle.md), [Routing](../providers/routing.md), [Provider configuration](../providers/configuration.md) | Keep route selection, attempt policy, profile construction, and requested-versus-served attribution in their owning layers. |
| Provider stream parsing, termination, or turn-level replay | [Provider routing lifecycle](../architecture/provider-routing-lifecycle.md), [Streaming](../providers/streaming.md), [Testing](./testing.md) | Keep wire completion in the adapter and whole-call replay in the runtime. Never replay after immutable event output is visible. |
...
| Logging, observability, runtime trace persistence, log pagination, retention, or schema migration | [Logging architecture](../architecture/logging.md), [Logs & observability](../ops/observability.md), [Runtime state and persistence](../architecture/runtime-state-and-persistence.md), [Gateway HTTP API](../gateway/api.md), [Security overview](../security/overview.md), [Testing](./testing.md) | One canonical event is offered independently to live broadcast and persisted JSONL; an optional typed Observer projection runs only when bound. Verify projection fields, active-file cursor lifetime, rewrite and retention behavior, migration compatibility, and privacy at the changed destination. |
