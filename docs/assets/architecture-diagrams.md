# QuantClaw Architecture Diagrams

This document provides visual representations of QuantClaw's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways QuantClaw can be run:**

```mermaid
flowchart TD
    Start[quantclaw CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[quantclaw daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[QuantClaw Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>QUANTCLAW_* env vars]
...
*Generated for QuantClaw v0.1.0 - Architecture Documentation*
