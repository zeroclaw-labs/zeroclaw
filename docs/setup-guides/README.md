...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `zeroclaw onboard --api-key sk-... --provider openrouter --model "openrouter/auto"` |
...
- Quick onboarding: `zeroclaw onboard --api-key "sk-..." --provider openrouter --model "openrouter/auto"`
