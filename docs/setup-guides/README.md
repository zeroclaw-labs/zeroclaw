...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `daemonclaw onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `daemonclaw onboard` |
| Config exists, just fix channels | `daemonclaw onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `daemonclaw onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `daemonclaw onboard --api-key "sk-..." --provider openrouter`
- Guided onboarding: `daemonclaw onboard`
...
- Validate environment: `daemonclaw status` + `daemonclaw doctor`
