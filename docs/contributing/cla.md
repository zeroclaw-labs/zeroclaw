# QuantClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to QuantClaw Labs. This agreement
protects both contributors and users of the QuantClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the QuantClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to QuantClaw Labs
  for inclusion in the QuantClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"QuantClaw Labs"** means the maintainers and organization responsible
  for the QuantClaw project at https://github.com/quant-speed/quantclaw.

---

## 2. Grant of Copyright License

You grant QuantClaw Labs and recipients of software distributed by QuantClaw
...
the QuantClaw project.

**This protects you:** if a third party files a patent claim against
QuantClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to QuantClaw
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with QuantClaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the QuantClaw name,
...
QuantClaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the QuantClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the QuantClaw repository,
...
https://github.com/quant-speed/quantclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the QuantClaw dual-license model.*
