...
DaemonClaw's architecture is trait-driven and modular.
...
```rust
// In your crate: use daemonclaw::tools::traits::{Tool, ToolResult};
...
Channels let DaemonClaw communicate through any messaging platform.
...
```rust
// In your crate: use daemonclaw::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects DaemonClaw to a different model API.
...
```rust
// In your crate: use daemonclaw::providers::traits::Provider;
...
```rust
// In your crate: use daemonclaw::memory::traits::{Memory, MemoryEntry, MemoryCategory};
