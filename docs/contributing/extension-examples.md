...
```rust
// In your crate: use quantclaw::tools::traits::{Tool, ToolResult};
...
```rust
// In your crate: use quantclaw::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects QuantClaw to a different model API.
...
```rust
// In your crate: use quantclaw::providers::traits::Provider;
...
```rust
// In your crate: use quantclaw::memory::traits::{Memory, MemoryEntry, MemoryCategory};
