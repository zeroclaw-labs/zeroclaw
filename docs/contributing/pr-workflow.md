# DaemonClaw PR Workflow (High-Volume Collaboration)

This document defines how DaemonClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to DaemonClaw/project-native labels.
...
- Confirm any required identity-like wording uses DaemonClaw/project-native terminology.
