# QuantClaw PR Workflow (High-Volume Collaboration)

This document defines how QuantClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to QuantClaw/project-native labels.
...
- Confirm any required identity-like wording uses QuantClaw/project-native terminology.
