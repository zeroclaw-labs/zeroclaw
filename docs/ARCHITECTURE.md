...
| `hub` | 15 | subtype 4종 분류, refresh+compile, Evidence Gap, priority_score 순서, 3중 상충 해소 순서, Light/Heavy/Full Rebuild 영향도 분기, compile queue next |
...
회귀 없음: memory 328 + sync 49 + phone 20 전부 green. **전체 합계 497 passed**.
