...
- Νέα ρύθμιση παρατηρησιμότητας: `observability.runtime_trace_record_http` (προεπιλογή `false`) για καταγραφή λεπτομερειών HTTP κλήσεων LLM (`llm_http_request` / `llm_http_response`).
