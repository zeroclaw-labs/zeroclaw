...
# --- Τεμαχισμός κειμένου (προαιρετικό) ---
# Μέγιστοι χαρακτήρες Unicode ανά εξερχόμενο μήνυμα. Παράλειψη για απενεργοποίηση.
# text_chunk_limit = 4000
# Στρατηγική τεμαχισμού: "length" (κατά τεμαχισμός byte στο όριο) | "newline" (τεμαχισμός στα \n).
# chunk_mode = "length"
```
