...
Cách cài đặt và khởi tạo DaemonClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài DaemonClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image DaemonClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.daemonclaw-docker`.
