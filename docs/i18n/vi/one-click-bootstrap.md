...
Cách cài đặt và khởi tạo QuantClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài QuantClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image QuantClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.quantclaw-docker`.
