# Tài liệu tham khảo Providers — QuantClaw
...
3. Biến môi trường dự phòng chung: `QUANTCLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, QuantClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, QuantClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `quantclaw models refresh --provider nvidia`
