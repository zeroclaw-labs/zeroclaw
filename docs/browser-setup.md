...
```bash
echo "Open https://example.com and tell me what it says" | quantclaw agent
```
...
```bash
# Content extraction
echo "Open https://example.com and summarize it" | quantclaw agent

# Navigation
echo "Go to https://github.com/trending and list the top 3 repos" | quantclaw agent

# Form interaction
echo "Go to Wikipedia, search for 'Rust programming language', and summarize" | quantclaw agent
```
...
- [QuantClaw Configuration Reference](./config-reference.md)
