...
This guide covers setting up browser automation capabilities in DaemonClaw, including both headless automation and GUI access via VNC.

## Overview

DaemonClaw supports multiple browser access methods:
...
```bash
echo "Open https://example.com and tell me what it says" | daemonclaw agent
```
...
### DaemonClaw Integration Tests

```bash
# Content extraction
echo "Open https://example.com and summarize it" | daemonclaw agent

# Navigation
echo "Go to https://github.com/trending and list the top 3 repos" | daemonclaw agent

# Form interaction
echo "Go to Wikipedia, search for 'Rust programming language', and summarize" | daemonclaw agent
```
...
- [DaemonClaw Configuration Reference](./config-reference.md)
