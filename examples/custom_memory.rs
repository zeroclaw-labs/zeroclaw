//! Example: Implementing a custom Memory backend for Aria
//!
...
// ── Re-define the trait types (in your app, import from afw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Aria Memory Demo — InMemoryBackend\n");
