...
| Installer Drift | Tracked installer, packaging, container, Nix, and installation-documentation surfaces match the canonical generator specification, and the tracked OpenRPC contract document matches `zeroclaw-rpc-proto`. | [PR #7558](https://github.com/zeroclaw-labs/zeroclaw/pull/7558) | Retire only when those surfaces are no longer generated and tracked, or an equivalent consistency check replaces this gate. |
