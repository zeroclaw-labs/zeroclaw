...
//! Run: `cargo bench`
//!
//! Ref: https://github.com/quant-speed/quantclaw/issues/618 (item 7)
...
use quantclaw::agent::dispatcher::{NativeToolDispatcher, ToolDispatcher, XmlToolDispatcher};
use quantclaw::config::MemoryConfig;
use quantclaw::memory;
use quantclaw::memory::{Memory, MemoryCategory};
use quantclaw::observability::{NoopObserver, Observer};
use quantclaw::providers::{ChatRequest, ChatResponse, Provider, ToolCall};
    ...
    let response = ChatResponse {
        ...
        tool_calls: vec![
            ToolCall {
                id: "tc1".into(),
                name: "search".into(),
                arguments: r#"{"query": "quantclaw"}"#.into(),
            },
            ToolCall {
                id: "tc2".into(),
                name: "read_file".into(),
