...
mod tests {
    ...
    fn client_csr_contains_request_and_key() {
        ...
        // Assert the PEM header in two halves: the key is generated by this
        // test, and a contiguous header literal trips secret-scanners on a
        // diff that contains no actual key material.
