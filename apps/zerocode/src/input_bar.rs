...
fn parse_slash_command(input: &str) -> SlashCommand<'_> {
    ...
    match spec.kind {
        ...
        SlashCommandKind::Browse => SlashCommand::EnterBrowseMode,
        ...
        SlashCommandKind::Help => SlashCommand::OpenHelp,
    ...
    fn help_context_keeps_slash_commands_out_of_general_help() {
        ...
        for command in SLASH_COMMANDS {
            assert!(
                ...
                "{} stays in autocomplete, not the general Help modal",
                command.name
            );
        }
    }
