...
zc-doctor-partial-results = ⚠ Partial results — model probing timed out after 20s. Results from earlier phases are shown below.
zc-doctor-timeout-hint = The model catalog lookup timed out. Check provider connectivity or try again later.
