...
zc-zerocode-tab-message-queue = Message queue
...
zc-zerocode-queue-title = Message queue ([message_queue] — Enter to edit)
zc-zerocode-queue-cap = Max queued messages
zc-zerocode-queue-default-width = Default side panel width
zc-zerocode-queue-min-width = Minimum side panel width
zc-zerocode-queue-max-width = Maximum side panel width
zc-zerocode-queue-width-step = Resize step
zc-zerocode-queue-auto-open = Auto-open on new message
zc-zerocode-queue-stay-open-when-empty = Stay open when empty
