...
zc-chat-history-trimmed = Earlier conversation history was trimmed: { $reason } ({ $dropped } older { $dropped-kind ->
    [one] turn
   *[other] turns
...
zc-chat-history-trimmed-legacy = Earlier conversation history was trimmed: { $reason } ({ $dropped } messages dropped; { $kept } turns kept).
