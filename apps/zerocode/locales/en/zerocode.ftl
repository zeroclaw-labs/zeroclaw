...
zc-chat-history-trimmed-tokens = Earlier conversation history was trimmed from approximately { $before } to { $after } tokens against a { $budget }-token budget; { $dropped } messages dropped and { $kept } turns kept.
