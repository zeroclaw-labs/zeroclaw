...
zc-zerocode-tab-todotracker = Todo tracker
...
zc-zerocode-todo-title = Todo tracker ([todotracker] — Enter to edit)
zc-zerocode-todo-enabled = Enabled
zc-zerocode-todo-enabled-at-start = Visible at start
zc-zerocode-todo-location = Location
zc-zerocode-todo-width = Side panel width
zc-zerocode-todo-max-height = Bottom max height
zc-zerocode-todo-loading = Loading todotracker config…
zc-zerocode-todo-load-failed = Failed to load todotracker config: { $err }
zc-zerocode-todo-saved = Saved. New Code sessions will use this.
zc-zerocode-todo-edit-int = Enter to save, Esc to cancel.
zc-zerocode-todo-edit-bool = Enter toggles; this field saves on toggle.
zc-zerocode-todo-edit-location = Enter cycles bottom / left / right.
zc-zerocode-help-todo = edit todo tracker field
