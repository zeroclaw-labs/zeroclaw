...
This is an experimental sideload release, not a Play Store package. The full flavor is for Android 12+;
the lite flavor supports Android 11+ without the AI Edge dependency. Both APKs
are arm64-v8a only because the bundled ZeroClaw executable is built for arm64.
