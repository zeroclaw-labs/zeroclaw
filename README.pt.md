...
<p align="center">
  ...
  <a href="install.sh">Configuração com Um Clique</a> |
...
O script `install.sh` instala Rust, clona ZeroClaw, compila, e configura seu ambiente de desenvolvimento inicial:
