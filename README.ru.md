...
|-----------|-------|---------------------|------------|
| **AI-модели** | `Provider` | Каталог через `zeroclaw providers` (сейчас 28 встроенных + алиасы, плюс пользовательские endpoint) | `azure-openai` (Azure OpenAI) или `custom:https://your-api.com` (OpenAI-совместимый), `anthropic-custom:https://your-api.com` |
