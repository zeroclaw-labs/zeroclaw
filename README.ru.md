...
> Примечание: результаты ZeroClaw измерены на release-сборке с помощью `/usr/bin/time -l`. OpenClaw требует Node.js runtime (около 390MB накладных расходов). PicoClaw и ZeroClaw — статические бинарники.
