...
Python companion package for [JhedaiClaw](https://github.com/jhedai/jhedaiclaw) — LangGraph-based tool calling for consistent LLM agent execution.
...
| Feature              | Rust JhedaiClaw | jhedaiclaw-tools     |
| -------------------- | --------------- | -------------------- |
...
Use **Rust JhedaiClaw** for production edge deployments. Use **jhedaiclaw-tools** when you need guaranteed tool calling consistency or Python ecosystem integration.
