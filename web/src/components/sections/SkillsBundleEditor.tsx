...
export default function SkillsBundleEditor({ bundle }: Props) {
  ...
  const dirty =
    buffer !== null &&
    JSON.stringify(buffer.draft) !== JSON.stringify(buffer.loaded);
        ...
        ? {
            ...
            draft: {
              ...
              frontmatter: {
                ...
                [field]:
                  value ||
                  (field === "name" || field === "description" ? "" : null),
              },
            },
          }
        : prev,
        ...
        {skills.map((s) => (
          <button
            ...
            style={{
              ...
              background:
                s.name === active ? "var(--pc-accent-glow)" : "transparent",
              color:
                s.name === active
                  ? "var(--pc-accent)"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() =>
                setBuffer((prev) =>
                  prev
                    ? { ...prev, draft: structuredClone(prev.loaded) }
                    : prev,
                )
              }
              className="btn-secondary text-sm"
            ...
            {!confirmDelete ? (
              ...
              <>
                ...
                >
                  ...
                  <code>shared/skills/_deleted/</code>
                  {t("skills_bundle.move_to_suffix")}
                </span>
                <button
                  type="button"
                  disabled={busy}
