...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // Memory Backend / Knowledge Graph
    "memory.tab_store": "Store",
    "memory.tab_graph": "Knowledge Graph",
    "memory.backend_select": "Backend",
    "memory.backend_confirm_title": "Change Memory Backend?",
    "memory.backend_confirm_msg":
      'Switching to "{backend}". The runtime will restart to apply this change.',
    "graph.stats_nodes": "Total Nodes",
    "graph.stats_backend": "Backend",
    "graph.stats_healthy": "Health",
    "graph.stats_daily_cost": "Daily Cost",
    "graph.search_placeholder": "Search knowledge graph...",
    "graph.hot_nodes": "Hot Nodes",
    "graph.all_nodes": "All Nodes",
    "graph.add_concept": "Add Concept",
    "graph.add_relation": "Add Relation",
    "graph.concept_name": "Concept Name",
    "graph.concept_description": "Description",
    "graph.concept_category": "Category (optional)",
    "graph.relation_from": "From Node ID",
    "graph.relation_to": "To Node ID",
    "graph.relation_type": "Relation Type (optional)",
    "graph.relation_weight": "Weight (optional, 0-1)",
    "graph.empty_nodes": "No nodes in the knowledge graph yet.",
    "graph.empty_hot": "No hot nodes above threshold.",
    "graph.confirm_delete": "Delete this node?",
    "graph.healthy_yes": "Healthy",
    "graph.healthy_no": "Unhealthy",
    "graph.not_active":
      "Graph backend is not active. Select 'graph' as your memory backend to enable.",
  ...
  tr: {
    ...
    "memory.confirm_delete":
      "Bu hafiza kaydini silmek istediginizden emin misiniz?",
    ...
    // Memory Backend / Knowledge Graph
    "memory.tab_store": "Depo",
    "memory.tab_graph": "Bilgi Grafigi",
    "memory.backend_select": "Motor",
    "memory.backend_confirm_title": "Hafiza Motoru Degistirilsin mi?",
    "memory.backend_confirm_msg":
      '"{backend}" motoruna geciliyor. Degisikligi uygulamak icin calisma zamani yeniden baslatilacak.',
    "graph.stats_nodes": "Toplam Dugum",
    "graph.stats_backend": "Motor",
    "graph.stats_healthy": "Saglik",
    "graph.stats_daily_cost": "Gunluk Maliyet",
    "graph.search_placeholder": "Bilgi grafiginde ara...",
    "graph.hot_nodes": "Sicak Dugumler",
    "graph.all_nodes": "Tum Dugumler",
    "graph.add_concept": "Kavram Ekle",
    "graph.add_relation": "Iliski Ekle",
    "graph.concept_name": "Kavram Adi",
    "graph.concept_description": "Aciklama",
    "graph.concept_category": "Kategori (opsiyonel)",
    "graph.relation_from": "Kaynak Dugum ID",
    "graph.relation_to": "Hedef Dugum ID",
    "graph.relation_type": "Iliski Tipi (opsiyonel)",
    "graph.relation_weight": "Agirlik (opsiyonel, 0-1)",
    "graph.empty_nodes": "Bilgi grafiginde henuz dugum yok.",
    "graph.empty_hot": "Esik degerinin ustunde sicak dugum yok.",
    "graph.confirm_delete": "Bu dugumu sil?",
    "graph.healthy_yes": "Saglikli",
    "graph.healthy_no": "Sagliksiz",
    "graph.not_active":
      "Grafik motoru aktif degil. Etkinlestirmek icin hafiza motoru olarak 'graph' secin.",
