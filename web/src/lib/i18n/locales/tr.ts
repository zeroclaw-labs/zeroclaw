...
const tr = {
    ...
    'settings.previewCode': 'const hello = \'ZeroClaw\'; // tipografi önizlemesi',
    'settings.font.systemMono': 'Sistem tek aralıklı',
    'settings.font.system': 'Sistem',
    'settings.active': 'Etkin',
    'settings.lightThemes': 'Açık Temalar',
    'settings.darkThemes': 'Koyu Temalar',
    ...
    'theme.accent.blue': 'Mavi',
    'theme.accent.rose': 'Gül',
    'theme.accent.amber': 'Kehribar',
    'theme.accent.emerald': 'Zümrüt',
    'theme.accent.violet': 'Mor',
    'theme.accent.cyan': 'Camgöbeği',
    'theme.name.oled-black': 'OLED Siyah',
    'theme.name.default-light': 'Varsayılan Açık',
    'theme.name.default-dark': 'Varsayılan Koyu',
