  ...
  return (
    <div className="p-6 space-y-4 animate-fade-in">
              ...
              entries.map((entry) => {
                ...
                return (
                  <li key={`${entry.kind}-${entry.name}`}>
                    <div
                      className={`flex items-stretch transition-colors ${isSelected ? "bg-pc-accent/10" : "hover:bg-[var(--pc-hover)]"}`}
                    >
                      <button
                        type="button"
                        onClick={() => {
            ...
            <>
              ...
              <div className="flex-1 overflow-auto p-4">
                {viewerLoading ? (
                  ...
                  <p className="text-sm text-status-error">{viewerError}</p>
                ) : viewer ? (
                  viewer.is_text ? (
                    ...
                    <p className="text-sm text-pc-text-muted">
                      {t("workspace.binary_file_prefix")} (
        ...
        message={
          pendingDelete ? (
            <>
              ...
              {pendingDelete.kind === "dir" &&
                ` ${t("workspace.delete_message_dir_note")}`}{" "}
      ...
      <PromptDialog
        ...
        title={
          renaming
            ? `${t("workspace.rename_title_prefix")} ${renaming}`
