...
<p align="center">
  ...
  <a href="install.sh">Konfiguracja Jednym Kliknięciem</a> |
...
Skrypt `install.sh` instaluje Rust, klonuje ZeroClaw, kompiluje go i konfiguruje twoje początkowe środowisko deweloperskie:
