    ...
    <>
      <aside className={`sidebar ${isOpen ? "" : "closed"}`}>
        ...
        <div className="sidebar-body">
          ...
          {/* Voice Chat (LiveKit) nav item */}
          <div className="sidebar-section">
            <div
              className={`sidebar-chat-item ${currentPage === "voicechat" ? "active" : ""}`}
            ...
            >
              <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span className="sidebar-chat-title">{locale === "ko" ? "AI 음성 대화" : "AI Voice Chat"}</span>
              </span>
            </div>
          </div>
