...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  en: {
    ...
    select_device_subtitle: "Choose which ZeroClaw device to connect to",
  ...
  ko: {
    ...
    select_device_subtitle: "\uC5F0\uACB0\uD560 ZeroClaw \uB514\uBC14\uC774\uC2A4\uB97C \uC120\uD0DD\uD558\uC138\uC694",
    device_online: "\uC628\uB77C\uC778",
    device_offline: "\uC624\uD504\uB77C\uC778",
    device_this: "\uC774 \uB514\uBC14\uC774\uC2A4",
    device_remote: "\uC6D0\uACA9",
    ...
    sidebar_chats: "\uB300\uD654",
    greeting_prompt: "[SYSTEM] 사용자가 처음 로그인했습니다. 아이디는 \"{username}\"입니다. 당신은 ZeroClaw, 사용자의 개인 AI 비서입니다. 정중하고 조심스러운 태도로 여러 단계에 걸쳐 대화를 시작하세요. 하나의 응답 안에서 다음 순서로 구성하세요:\n1. 먼저 따뜻하게 자기소개: \"안녕하세요. 저는 ZeroClaw라고 합니다. 간단하게 저를 소개하면 사용자님의 개인 AI 비서입니다. 앞으로 잘 부탁드립니다.\"\n2. 그 다음, 조심스럽게 이름과 직업을 여쭤보기: \"혹시 사용자님의 이름과 직업을 여쭈어봐도 될까요?\"\n3. 마지막으로, 호칭을 어떻게 하면 좋을지 정중하게 묻기: \"실례가 되지 않는다면 제가 사용자님을 어떤 호칭으로 부르는 것이 좋을까요?\"\n위 내용을 참고하되 자연스럽게 변형하여 말하세요. 처음 만나는 중요한 분을 대하듯 공손하고 예의바르게 대화하세요. 지나치게 캐주얼하지 않게, 따뜻하지만 전문적인 비서의 톤을 유지하세요. 반드시 한국어로 대화하세요.",
    greeting_prompt_returning: "[SYSTEM] \uC0AC\uC6A9\uC790 \"{username}\"\uB2D8\uC774 \uB85C\uADF8\uC778\uD588\uC2B5\uB2C8\uB2E4. \uB2F9\uC2E0\uC740 \uAC1C\uC778 AI \uBE44\uC11C ZeroClaw\uC785\uB2C8\uB2E4. \uC0AC\uC6A9\uC790\uB97C \uC798 \uC544\uB294 \uBE44\uC11C\uCC98\uB7FC \uC778\uC0AC\uD558\uC138\uC694. \uAE30\uC5B5\uD558\uACE0 \uC788\uB294 \uC815\uBCF4(\uC774\uB984, \uC9C1\uC5C5, \uC120\uD638\uB3C4)\uB97C \uD65C\uC6A9\uD558\uC138\uC694. \uB530\uB73B\uD558\uACE0 \uAC04\uACB0\uD558\uAC8C, \uC624\uB298 \uBB34\uC5C7\uC744 \uB3C4\uC640\uB4DC\uB9B4\uC9C0 \uBB3C\uC5B4\uBD10\uC8FC\uC138\uC694. \uD55C\uAD6D\uC5B4\uB85C \uB300\uD654\uD558\uC138\uC694.",
  },
};
