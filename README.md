...
- **Hardware-capable** — GPIO / I2C / SPI / USB on Raspberry Pi, STM32, Arduino, and ESP32 via the `Peripheral` trait, plus a higher-level [robot control toolkit](crates/robot-kit) (`zeroclaw-robot-kit`) covering drive, vision, speech, sensors, and safety. See [Hardware](docs/book/src/hardware/index.md).
