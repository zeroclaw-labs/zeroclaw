...
| ----------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| **AI Models**     | `Provider`       | Provider catalog via `zeroclaw providers` (built-ins + aliases, plus custom endpoints)                                                                                     | `azure-openai` (Azure OpenAI), `custom:https://your-api.com` (OpenAI-compatible), or `anthropic-custom:https://your-api.com` |
