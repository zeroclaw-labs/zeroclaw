//! DaemonClaw Pico firmware — JSON-over-serial peripheral.
//!
...
use heapless::String;
use daemonclaw_fw_protocol::{copy_id, write_err, write_ok, Command};
...
async fn main(_spawner: Spawner) {
    ...
    info!("DaemonClaw Pico firmware ready on UART0 (115200)");
