# DaemonClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for DaemonClaw edge scenarios on ESP32.
...
3. Connect UI state with DaemonClaw edge/runtime messaging
...
- [DaemonClaw Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
