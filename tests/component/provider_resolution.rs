...
use quantclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use quantclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = quantclaw::providers::ProviderRuntimeOptions::default();
