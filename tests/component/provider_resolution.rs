...
use daemonclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use daemonclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = daemonclaw::providers::ProviderRuntimeOptions::default();
