...
use jhedaiclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use jhedaiclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = jhedaiclaw::providers::ProviderRuntimeOptions::default();
