...
//! verification) in isolation. The gateway module (`daemonclaw::gateway`) exposes
...
use daemonclaw::gateway::verify_whatsapp_signature;
...
fn gateway_body_limit_is_reasonable() {
    assert_eq!(
        daemonclaw::gateway::MAX_BODY_SIZE,
        65_536,
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        daemonclaw::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        daemonclaw::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
