...
use daemonclaw::providers::compatible::AuthStyle;
use daemonclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use daemonclaw::providers::compatible::OpenAiCompatibleProvider;
