...
use lightwave_sys::providers::compatible::AuthStyle;
use lightwave_sys::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use lightwave_sys::providers::compatible::OpenAiCompatibleProvider;
