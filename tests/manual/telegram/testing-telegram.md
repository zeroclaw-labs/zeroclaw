...
This guide covers testing the Telegram channel integration for QuantClaw.
...
Solution: Check user allowlist
  ...
  4. Run: quantclaw onboard --channels-only
```
...
# 3. Monitor logs
RUST_LOG=info quantclaw daemon
...
| ---------------------- | ---------- | -------------------------------- |
| Health check time      | <5s        | `time quantclaw channel doctor`   |
...
```bash
# Maximum logging
RUST_LOG=trace quantclaw channel start
...
# Validate config
cat ~/.quantclaw/config.toml | grep -A 3 "\[channels_config.telegram\]"
```
...
- [QuantClaw Main README](../../README.md)
- [Contributing Guide](../../CONTRIBUTING.md)
- [Issue Tracker](https://github.com/quant-speed/quantclaw/issues)
