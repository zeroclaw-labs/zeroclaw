...
//!
//! Ref: https://github.com/lightwave_sys-labs/lightwave_sys/issues/618 (item 6)
...
use lightwave_sys::providers::traits::ChatMessage;
use lightwave_sys::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: lightwave_sys"));
