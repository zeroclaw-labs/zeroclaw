...
//!
//! Ref: https://github.com/jhedai/jhedaiclaw/issues/618 (item 6)
...
use jhedaiclaw::providers::traits::ChatMessage;
use jhedaiclaw::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: jhedaiclaw"));
