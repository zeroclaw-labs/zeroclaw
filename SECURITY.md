...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/quant-speed/quantclaw/security/advisories/new)
...
QuantClaw implements defense-in-depth security:
...
QuantClaw Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' quantclaw
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace quantclaw gateway
```
