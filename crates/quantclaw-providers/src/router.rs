...
mod tests {
    ...
    // Arc<MockProvider> Provider impl provided by blanket impl in quantclaw-types.
    ...
    // Arc<StreamingMockProvider> Provider impl provided by blanket impl in quantclaw-types.
    ...
    // Arc<ToolEventStreamingMockProvider> Provider impl provided by blanket impl in quantclaw-types.
