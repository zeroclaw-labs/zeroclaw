...
mod tests {
    ...
    // Arc<ModelAwareMock> Provider impl provided by blanket impl in quantclaw-types.
    ...
    // Arc<NativeModelAwareMock> Provider impl provided by blanket impl in quantclaw-types.
    ...
    // Arc<StreamingToolEventMock> Provider impl provided by blanket impl in quantclaw-types.
