...
use zeroclaw_config::schema::{
    ...
    GroqModelProviderConfig, HailoOllamaEndpoint, HailoOllamaModelProviderConfig,
    ...
    MinimaxModelProviderConfig, MistralModelProviderConfig, ModelEndpoint, MoonshotEndpoint,
