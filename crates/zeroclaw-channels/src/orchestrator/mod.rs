...
use zeroclaw_runtime::agent::loop_::{
    LoopContext, apply_text_tool_prompt_policy, build_tool_instructions_for_names,
    clear_model_switch_request, get_model_switch_state, is_model_switch_requested,
    run_tool_call_loop_ctx, scope_session_key, scope_thread_id, scrub_credentials,
};
                ...
                result = tokio::time::timeout(
                    ...
                    scope_session_key(
                        ...
                        run_tool_call_loop_ctx(LoopContext {
                            ...
                            pacing: &ctx.pacing,
                            strict_tool_parsing: ctx.prompt_config
                            ...
                            // Collector is meaningful only when the
                            // generator is active. Pass None when receipts
                            // are disabled so the call site reflects that
                            // coupling explicitly.
                            collected_receipts: ctx.receipt_generator
                                .as_ref()
