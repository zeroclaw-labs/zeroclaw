                ...
                for msg in msgs {
                    ...
                    if !self.is_number_allowed(&normalized_from) {
                        ::zeroclaw_log::record!(
                            ...
                            "ignoring message from unauthorized number: . Add to channels.whatsapp.allowed_numbers in config.toml, or run `zeroclaw config set channels.whatsapp.allowed_numbers='[\"<msisdn>\"]'`."
                        );
                        continue;
                    }
