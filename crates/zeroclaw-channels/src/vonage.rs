...
impl ::zeroclaw_api::attribution::Attributable for VonageChannel {
    fn role(&self) -> ::zeroclaw_api::attribution::Role {
        ::zeroclaw_api::attribution::Role::Channel(::zeroclaw_api::attribution::ChannelKind::Vonage)
    }
    fn alias(&self) -> &str {
        ""
    }
...
impl Channel for VonageChannel {
    ...
    async fn listen(&self, _tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> Result<()> {
        ...
        // Configure Vonage's "Inbound SMS Webhook" to POST to the gateway's
        // VONAGE_WEBHOOK_PATH endpoint.
        loop {
