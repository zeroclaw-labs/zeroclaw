...
impl ::zeroclaw_api::attribution::Attributable for SinchChannel {
    fn role(&self) -> ::zeroclaw_api::attribution::Role {
        ::zeroclaw_api::attribution::Role::Channel(::zeroclaw_api::attribution::ChannelKind::Sinch)
    }
    fn alias(&self) -> &str {
        ""
    }
...
impl Channel for SinchChannel {
    ...
    async fn listen(&self, _tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> Result<()> {
        ...
        // Configure Sinch's Callback URL to POST to the gateway's
        // SINCH_WEBHOOK_PATH endpoint.
        loop {
