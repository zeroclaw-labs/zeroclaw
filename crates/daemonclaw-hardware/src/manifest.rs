//! Plugin manifest — `~/.daemonclaw/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how DaemonClaw spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, DaemonClaw will prefer the named transport kind
