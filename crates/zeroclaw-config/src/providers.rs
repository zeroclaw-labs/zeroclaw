...
use super::schema::{
    ...
    BedrockModelProviderConfig, CerebrasModelProviderConfig, CheaperInferenceModelProviderConfig,
...
macro_rules! for_each_model_provider_slot {
    ($mac:ident) => {
        $mac! {
            ...
            (cheaperinference, "cheaperinference", CheaperInferenceModelProviderConfig),
