...
use std::fmt;
use quantclaw_macros::Configurable;
...
fn default_subject() -> String {
    "QuantClaw Message".into()
}
fn default_max_attachment_bytes() -> usize {
    25 * 1024 * 1024
}

#[derive(Debug, Clone, Serialize, Deserialize, quantclaw_macros::Configurable)]
#[cfg_attr(feature = "schema-export", derive(schemars::JsonSchema))]
...
#[derive(Debug, Clone, Default, Serialize, Deserialize, quantclaw_macros::Configurable)]
#[cfg_attr(feature = "schema-export", derive(schemars::JsonSchema))]
