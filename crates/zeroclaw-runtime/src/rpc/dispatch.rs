...
mod tests {
    ...
    async fn context_usage_vision_routing_carries_vision_provider_window() {
        ...
        use zeroclaw_api::agent::{TurnAttribution, TurnEvent, TurnOutcome};
        use zeroclaw_api::attribution::{Attributable, ModelProviderKind, ProviderKind, Role};
        use zeroclaw_api::model_provider::ModelProvider;
        use zeroclaw_config::schema::{
            AliasedAgentConfig, Config, MultimodalConfig, RuntimeProfileConfig,
        };
        ...
        let mut config = Config {
            ...
            data_dir: std::path::PathBuf::from("/tmp/test_data"),
            ..Default::default()
        };
        ...
        let usage = events
            ...
            .find_map(|e| match e {
                TurnEvent::Usage { provider_ref, .. }
                    if provider_ref == "custom.vision-provider" =>
                {
                    Some(e)
                }
                _ => None,
        ...
        assert_eq!(
            provider_ref, "custom.vision-provider",
