                ...
                "delivery": {
                    ...
                    "properties": {
                        ...
                        "channel": {
                            ...
                            "description": "Channel type to deliver output to. From a chat turn this resolves to that conversation's own channel instance; pass '<type>.<alias>' to deliver elsewhere."
                        },
                        "to": {
                            "type": "string",
