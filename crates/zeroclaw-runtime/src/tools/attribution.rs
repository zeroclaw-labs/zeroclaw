...
use crate::tools::goal_objective::GoalObjectiveTool;
use crate::tools::goal_resume::GoalResumeTool;
use crate::tools::goal_start::GoalStartTool;
...
tool_attribution!(GoalObjectiveTool, ToolKind::Plugin);
tool_attribution!(GoalResumeTool, ToolKind::Plugin);
tool_attribution!(GoalStartTool, ToolKind::Plugin);
