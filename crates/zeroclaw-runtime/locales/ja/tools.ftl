...
tool-knowledge = アーキテクチャ決定、ソリューションパターン、経験、専門家、クライアント関係の知識グラフを管理します。アクション：capture、search、relate、suggest、expert_find、lessons_extract、graph_stats、client_network、interaction_log。
