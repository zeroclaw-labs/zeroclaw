...
tool-knowledge = アーキテクチャ決定、ソリューションパターン、経験、専門家、関係リンクの知識グラフを管理します。アクション：capture、search、relate、suggest、expert_find、lessons_extract、graph_stats、graph_neighbors、client_network、interaction_log。
