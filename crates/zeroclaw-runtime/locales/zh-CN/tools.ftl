...
tool-knowledge = 管理架构决策、解决方案模式、经验教训、专家和客户关系的知识图谱。操作：capture、search、relate、suggest、expert_find、lessons_extract、graph_stats、client_network、interaction_log。
