...
tool-session-prompt-list = Enumerar los adjuntos de instrucciones persistentes de la sesión de chat que está ejecutando actualmente este agente.
tool-session-prompt-set = Crear o reemplazar un adjunto de instrucción persistente para la sesión de chat actual.
tool-session-prompt-delete = Eliminar un adjunto de instrucción persistente de la sesión de chat actual.
tool-session-prompt-param-id = ID simbólico en minúsculas: [a-z][a-z0-9_.-]{"{"}0,63{"}"}.
tool-session-prompt-param-content = Texto de la instrucción, hasta 2048 bytes UTF-8.
tool-session-prompt-error-no-context = No hay un contexto de sesión de chat activo. Esta herramienta no está disponible para llamadas auxiliares.
tool-session-prompt-error-no-backend = No hay un backend de sesión de chat activo. Esta herramienta no está disponible para llamadas auxiliares.
tool-session-prompt-error-missing-id = Falta el parámetro «id».
tool-session-prompt-error-missing-content = Falta el parámetro «content».
tool-session-prompt-error-list = No se pudieron enumerar las instrucciones de sesión: { $err }
tool-session-prompt-error-set = No se pudo establecer la instrucción de sesión: { $err }
tool-session-prompt-error-delete = No se pudo eliminar la instrucción de sesión: { $err }
tool-session-prompt-set-created = Se creó la instrucción de sesión «{ $id }»; se aplicará en el siguiente turno de nivel superior.
tool-session-prompt-set-updated = Se actualizó la instrucción de sesión «{ $id }»; se aplicará en el siguiente turno de nivel superior.
tool-session-prompt-delete-success = Se eliminó la instrucción de sesión «{ $id }»; el cambio se aplicará en el siguiente turno de nivel superior.
tool-session-prompt-error-missing = La instrucción de sesión «{ $id }» no existe.
