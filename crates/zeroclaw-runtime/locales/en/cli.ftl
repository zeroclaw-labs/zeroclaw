...
cli-quickstart-inkbox-no-phone = This agent has no phone number attached.
cli-quickstart-inkbox-phone-unlocks = A local US number unlocks SMS and voice for this agent.
cli-quickstart-inkbox-provision-now = Provision a local phone number now?
...
cli-quickstart-inkbox-new-phone = Provision a local phone number? (unlocks SMS + voice)
