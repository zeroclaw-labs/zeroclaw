...
cli-quickstart-inkbox-dedicated-header = --- Dedicated phone number ---
cli-quickstart-inkbox-dedicated-explain = A local US number gives this agent its own line for SMS and voice.
cli-quickstart-inkbox-dedicated-provision = Provision a dedicated phone number now?
cli-quickstart-inkbox-dedicated-already = ✓ Already provisioned:
cli-quickstart-inkbox-dedicated-skip = Skipped. Rerun setup anytime to add a number.
cli-quickstart-inkbox-dedicated-pricing1 = Dedicated phone numbers are available on Inkbox paid tiers —
cli-quickstart-inkbox-dedicated-pricing2 = see https://inkbox.ai/pricing for details.
cli-quickstart-inkbox-dedicated-pricing3 = (provisioning response:
...
cli-quickstart-inkbox-attempts-used = attempts used
cli-quickstart-inkbox-code-resend-only = Type 'resend' for a new code
cli-quickstart-inkbox-code-dead = This code is dead. Type 'resend' before trying another code.
cli-quickstart-inkbox-code-now-dead = This code is now dead. Type 'resend' for a fresh one.
...
cli-quickstart-inkbox-no-identities = Agent-scoped key but no identity returned.
...
cli-quickstart-inkbox-create-new = + Create a new identity
cli-quickstart-inkbox-pick-identity = Select the identity this gateway runs as
cli-quickstart-inkbox-mint-failed = could not mint a scoped key:
cli-quickstart-inkbox-minted = ✓ minted an agent-scoped key for
...
cli-quickstart-inkbox-new-handle = Agent handle for the new identity (globally unique)
cli-quickstart-inkbox-new-display = Display name (shown to recipients, optional)
cli-quickstart-inkbox-new-created = ✓ created identity
cli-quickstart-inkbox-new-failed = could not create identity:
...
cli-quickstart-inkbox-imsg-explain3 = Once connected, the agent can also make and take voice calls with you
cli-quickstart-inkbox-imsg-explain4 = over that same shared iMessage line.
cli-quickstart-inkbox-imsg-status-failed = could not check iMessage status:
cli-quickstart-inkbox-imsg-already-enabled = ✓ iMessage is already enabled for this agent.
cli-quickstart-inkbox-imsg-already-connected = ✓ Already connected:
...
cli-quickstart-inkbox-imsg-connect-another = Connect another iPhone to this agent now?
