...
cli-quickstart-needs-tty = Quickstart is interactive and needs a terminal. Run it from an interactive shell, or use `zeroclaw config set <path> <value>` for headless configuration.
