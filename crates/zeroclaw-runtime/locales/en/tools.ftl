...
tool-knowledge = Manage a knowledge graph of architecture decisions, solution patterns, lessons learned, experts, and relationship links. Actions: capture, search, relate, suggest, expert_find, lessons_extract, graph_stats, graph_neighbors, client_network, interaction_log.
