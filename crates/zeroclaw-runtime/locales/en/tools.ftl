...
tool-computer-use-param-application = Exact application name or bundle identifier admitted by the configured application-access policy.
tool-computer-use-param-expected-application = Exact application name or bundle identifier that must be frontmost and policy-admitted before input is sent.
