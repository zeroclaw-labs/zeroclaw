...
impl WebAuthnManager {
    ...
    /// will be stored (typically `~/.quantclaw/`).
...
mod tests {
    ...
    fn start_registration_returns_valid_challenge() {
        ...
        assert_eq!(creation.rp.name, "QuantClaw Test");
    ...
    fn default_config_has_sane_values() {
        ...
        assert_eq!(config.rp_name, "QuantClaw");
    }
}
