//! Nevis IAM authentication provider for QuantClaw.
//!
...
//! roles to QuantClaw tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "quantclaw_user");
