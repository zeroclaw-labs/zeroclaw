...
const OTP_ISSUER: &str = "QuantClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(quantclaw_dir);
...
pub fn secret_file_path(quantclaw_dir: &Path) -> PathBuf {
    quantclaw_dir.join(OTP_SECRET_FILE)
}
