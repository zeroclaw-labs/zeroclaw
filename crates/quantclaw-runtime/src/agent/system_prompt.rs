...
pub fn build_system_prompt(
    ...
    tools: &[(&str, &str)],
    skills: &[Skill],
    identity_config: Option<&quantclaw_config::schema::IdentityConfig>,
    ...
    build_system_prompt_with_mode(
        ...
        bootstrap_max_chars,
        false,
        quantclaw_config::schema::SkillsPromptInjectionMode::Full,
...
pub fn build_system_prompt_with_mode(
    ...
    bootstrap_max_chars: Option<usize>,
    native_tools: bool,
    skills_prompt_mode: quantclaw_config::schema::SkillsPromptInjectionMode,
    autonomy_level: AutonomyLevel,
) -> String {
    let autonomy_cfg = quantclaw_config::schema::AutonomyConfig {
...
pub fn build_system_prompt_with_mode_and_autonomy(
    ...
    identity_config: Option<&quantclaw_config::schema::IdentityConfig>,
    bootstrap_max_chars: Option<usize>,
    autonomy_config: Option<&quantclaw_config::schema::AutonomyConfig>,
    native_tools: bool,
    skills_prompt_mode: quantclaw_config::schema::SkillsPromptInjectionMode,
    ...
    if prompt.is_empty() {
        "You are QuantClaw, a fast and efficient AI assistant built in Rust. Be helpful, concise, and direct."
            .to_string()
    } else {
        prompt
    }
