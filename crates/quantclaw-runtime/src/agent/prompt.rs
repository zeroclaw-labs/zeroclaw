...
use std::fmt::Write;
use std::path::Path;
use quantclaw_config::schema::IdentityConfig;
...
pub struct PromptContext<'a> {
    ...
    pub skills: &'a [Skill],
    pub skills_prompt_mode: quantclaw_config::schema::SkillsPromptInjectionMode,
...
mod tests {
    ...
    fn identity_section_with_aieos_includes_workspace_files() {
        let workspace =
            std::env::temp_dir().join(format!("quantclaw_prompt_test_{}", uuid::Uuid::new_v4()));
        ...
        let identity_config = quantclaw_config::schema::IdentityConfig {
            format: "aieos".into(),
            aieos_path: None,
        ...
        let ctx = PromptContext {
            ...
            tools: &tools,
            skills: &[],
            skills_prompt_mode: quantclaw_config::schema::SkillsPromptInjectionMode::Full,
    ...
    fn skills_section_compact_mode_omits_instructions_but_keeps_tools() {
        ...
        let ctx = PromptContext {
            ...
            tools: &tools,
            skills: &skills,
            skills_prompt_mode: quantclaw_config::schema::SkillsPromptInjectionMode::Compact,
            identity_config: None,
            dispatcher_instructions: "",
            tool_descriptions: None,
            security_summary: None,
