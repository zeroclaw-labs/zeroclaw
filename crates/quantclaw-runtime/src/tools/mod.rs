...
// Tool types from quantclaw-tools (direct imports, no shims)
pub use quantclaw_tools::ask_user::AskUserTool;
pub use quantclaw_tools::ask_user::ChannelMapHandle;
pub use quantclaw_tools::backup_tool::BackupTool;
pub use quantclaw_tools::browser::{BrowserTool, ComputerUseConfig};
pub use quantclaw_tools::browser_delegate::BrowserDelegateTool;
pub use quantclaw_tools::browser_open::BrowserOpenTool;
pub use quantclaw_tools::calculator::CalculatorTool;
pub use quantclaw_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use quantclaw_tools::canvas::{CanvasStore, CanvasTool};
pub use quantclaw_tools::claude_code::ClaudeCodeTool;
pub use quantclaw_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use quantclaw_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use quantclaw_tools::cloud_ops::CloudOpsTool;
pub use quantclaw_tools::cloud_patterns::CloudPatternsTool;
pub use quantclaw_tools::codex_cli::CodexCliTool;
pub use quantclaw_tools::composio::ComposioTool;
pub use quantclaw_tools::content_search::ContentSearchTool;
pub use quantclaw_tools::data_management::DataManagementTool;
pub use quantclaw_tools::discord_search::DiscordSearchTool;
pub use quantclaw_tools::escalate::EscalateToHumanTool;
pub use quantclaw_tools::file_edit::FileEditTool;
pub use quantclaw_tools::file_write::FileWriteTool;
pub use quantclaw_tools::gemini_cli::GeminiCliTool;
pub use quantclaw_tools::git_operations::GitOperationsTool;
pub use quantclaw_tools::glob_search::GlobSearchTool;
pub use quantclaw_tools::google_workspace::GoogleWorkspaceTool;
pub use quantclaw_tools::hardware_board_info::HardwareBoardInfoTool;
pub use quantclaw_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use quantclaw_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use quantclaw_tools::http_request::HttpRequestTool;
pub use quantclaw_tools::image_gen::ImageGenTool;
pub use quantclaw_tools::image_info::ImageInfoTool;
pub use quantclaw_tools::jira_tool::JiraTool;
pub use quantclaw_tools::knowledge_tool::KnowledgeTool;
pub use quantclaw_tools::linkedin::LinkedInTool;
pub use quantclaw_tools::llm_task::LlmTaskTool;
pub use quantclaw_tools::mcp_client::McpRegistry;
pub use quantclaw_tools::mcp_deferred::{
    ActivatedToolSet, DeferredMcpToolSet, build_deferred_tools_section,
};
pub use quantclaw_tools::mcp_tool::McpToolWrapper;
pub use quantclaw_tools::memory_export::MemoryExportTool;
pub use quantclaw_tools::memory_forget::MemoryForgetTool;
pub use quantclaw_tools::memory_purge::MemoryPurgeTool;
pub use quantclaw_tools::memory_recall::MemoryRecallTool;
pub use quantclaw_tools::memory_store::MemoryStoreTool;
pub use quantclaw_tools::microsoft365::Microsoft365Tool;
pub use quantclaw_tools::model_routing_config::ModelRoutingConfigTool;
pub use quantclaw_tools::notion_tool::NotionTool;
pub use quantclaw_tools::opencode_cli::OpenCodeCliTool;
#[cfg(feature = "rag-pdf")]
pub use quantclaw_tools::pdf_read::PdfReadTool;
pub use quantclaw_tools::pipeline::PipelineTool;
pub use quantclaw_tools::poll::PollTool;
pub use quantclaw_tools::project_intel::ProjectIntelTool;
pub use quantclaw_tools::proxy_config::ProxyConfigTool;
pub use quantclaw_tools::pushover::PushoverTool;
pub use quantclaw_tools::reaction::ReactionTool;
pub use quantclaw_tools::report_template_tool::ReportTemplateTool;
pub use quantclaw_tools::screenshot::ScreenshotTool;
pub use quantclaw_tools::sessions::{SessionsHistoryTool, SessionsListTool, SessionsSendTool};
pub use quantclaw_tools::swarm::SwarmTool;
pub use quantclaw_tools::text_browser::TextBrowserTool;
pub use quantclaw_tools::tool_search::ToolSearchTool;
pub use quantclaw_tools::weather_tool::WeatherTool;
pub use quantclaw_tools::web_fetch::WebFetchTool;
pub use quantclaw_tools::web_search_tool::WebSearchTool;
pub use quantclaw_tools::workspace_tool::WorkspaceTool;
pub use quantclaw_tools::wrappers::{PathGuardedTool, RateLimitedTool};

// Traits from quantclaw-api
pub use quantclaw_api::schema::{CleaningStrategy, SchemaCleanr};
pub use quantclaw_api::tool::{Tool, ToolResult, ToolSpec};
...
use std::sync::Arc;
use quantclaw_config::schema::{Config, DelegateAgentConfig};
use quantclaw_memory::Memory;
...
pub fn all_tools(
    ...
    browser_config: &quantclaw_config::schema::BrowserConfig,
    http_config: &quantclaw_config::schema::HttpRequestConfig,
    web_fetch_config: &quantclaw_config::schema::WebFetchConfig,
    workspace_dir: &std::path::Path,
    agents: &HashMap<String, DelegateAgentConfig>,
    fallback_api_key: Option<&str>,
    root_config: &quantclaw_config::schema::Config,
...
pub fn all_tools_with_runtime(
    ...
    if root_config.channels_config.discord_history.is_some() {
        match quantclaw_memory::SqliteMemory::new_named(workspace_dir, "discord") {
            Ok(discord_mem) => {
    ...
    // LLM task tool — always registered when a provider is configured
    {
        ...
        let llm_task_runtime_options =
            quantclaw_providers::provider_runtime_options_from_config(root_config);
    ...
    if let Ok(session_store) = quantclaw_infra::session_store::SessionStore::new(workspace_dir) {
        let backend: Arc<dyn quantclaw_infra::session_backend::SessionBackend> =
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = quantclaw_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match quantclaw_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    if root_config.workspace.enabled {
        ...
        let ws_manager = quantclaw_config::workspace::WorkspaceManager::new(workspaces_dir);
            ...
            match quantclaw_plugins::host::PluginHost::new(
                ...
                Ok(host) => {
                    ...
                    for manifest in tool_manifests {
                        tool_arcs.push(Arc::new(quantclaw_plugins::wasm_tool::WasmTool::new(
                            manifest.name.clone(),
...
mod tests {
    ...
    use quantclaw_config::schema::{BrowserConfig, Config, MemoryConfig};
    ...
    fn all_tools_excludes_browser_when_disabled() {
        ...
        let mem: Arc<dyn Memory> =
            Arc::from(quantclaw_memory::create_memory(&mem_cfg, tmp.path(), None).unwrap());
        ...
        let http = quantclaw_config::schema::HttpRequestConfig::default();
        ...
        let (tools, _, _, _, _, _) = all_tools(
            ...
            &browser,
            &http,
            &quantclaw_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &cfg,
    ...
    fn all_tools_excludes_read_skill_in_full_mode() {
        ...
        let http = quantclaw_config::schema::HttpRequestConfig::default();
        let mut cfg = test_config(&tmp);
        cfg.skills.prompt_injection_mode = quantclaw_config::schema::SkillsPromptInjectionMode::Full;
