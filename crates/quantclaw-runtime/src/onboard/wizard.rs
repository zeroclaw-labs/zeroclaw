...
use quantclaw_config::schema::{HardwareConfig, HardwareTransport};
#[cfg(feature = "channel-nostr")]
use quantclaw_config::schema::{NostrConfig, default_nostr_relays};
use quantclaw_memory::{
    default_memory_backend_key, memory_backend_profile, selectable_memory_backends,
};
use quantclaw_providers::{
...
/// implementations live in downstream crates (quantclaw-hardware, quantclaw-channels).
///
/// NOTE: Transitional bridge — see RFC #5574 Phase 2 D4. This struct will be
/// replaced when `quantclaw onboard` integrates with `PluginRegistry::install`.
#[derive(Default)]
...
const BANNER: &str = r"
    ...
    Produced by quant-speed. 100% Rust. 100% Agnostic.
...
pub async fn run_wizard(force: bool, callbacks: WizardCallbacks) -> Result<Config> {
    ...
    println!(
        "  {}",
        style("Welcome to QuantClaw — the fastest, smallest AI assistant.")
            .white()
            .bold()
    );
    println!(
    ...
    print_step(3, 9, "Channels (How You Talk to QuantClaw)");
    ...
    let config = Config {
        ...
        backup: quantclaw_config::schema::BackupConfig::default(),
        data_retention: quantclaw_config::schema::DataRetentionConfig::default(),
        cloud_ops: quantclaw_config::schema::CloudOpsConfig::default(),
        conversational_ai: quantclaw_config::schema::ConversationalAiConfig::default(),
        security: quantclaw_config::schema::SecurityConfig::default(),
        security_ops: quantclaw_config::schema::SecurityOpsConfig::default(),
        runtime: RuntimeConfig::default(),
        reliability: quantclaw_config::schema::ReliabilityConfig::default(),
        scheduler: quantclaw_config::schema::SchedulerConfig::default(),
        agent: quantclaw_config::schema::AgentConfig::default(),
        pacing: quantclaw_config::schema::PacingConfig::default(),
        skills: quantclaw_config::schema::SkillsConfig::default(),
        pipeline: quantclaw_config::schema::PipelineConfig::default(),
        model_routes: Vec::new(),
        embedding_routes: Vec::new(),
        heartbeat: HeartbeatConfig::default(),
        cron: quantclaw_config::schema::CronConfig::default(),
        channels_config,
        memory: memory_config, // User-selected memory backend
        storage: StorageConfig::default(),
        tunnel: tunnel_config,
        gateway: quantclaw_config::schema::GatewayConfig::default(),
        composio: composio_config,
        microsoft365: quantclaw_config::schema::Microsoft365Config::default(),
        secrets: secrets_config,
        browser: BrowserConfig::default(),
        browser_delegate: quantclaw_tools::browser_delegate::BrowserDelegateConfig::default(),
        http_request: quantclaw_config::schema::HttpRequestConfig::default(),
        multimodal: quantclaw_config::schema::MultimodalConfig::default(),
        media_pipeline: quantclaw_config::schema::MediaPipelineConfig::default(),
        web_fetch: quantclaw_config::schema::WebFetchConfig::default(),
        link_enricher: quantclaw_config::schema::LinkEnricherConfig::default(),
        text_browser: quantclaw_config::schema::TextBrowserConfig::default(),
        web_search: quantclaw_config::schema::WebSearchConfig::default(),
        project_intel: quantclaw_config::schema::ProjectIntelConfig::default(),
        google_workspace: quantclaw_config::schema::GoogleWorkspaceConfig::default(),
        proxy: quantclaw_config::schema::ProxyConfig::default(),
        identity: quantclaw_config::schema::IdentityConfig::default(),
        cost: quantclaw_config::schema::CostConfig::default(),
        peripherals: quantclaw_config::schema::PeripheralsConfig::default(),
        delegate: quantclaw_config::schema::DelegateToolConfig::default(),
        agents: std::collections::HashMap::new(),
        swarms: std::collections::HashMap::new(),
        hooks: quantclaw_config::schema::HooksConfig::default(),
        hardware: hardware_config,
        query_classification: quantclaw_config::schema::QueryClassificationConfig::default(),
        transcription: quantclaw_config::schema::TranscriptionConfig::default(),
        tts: quantclaw_config::schema::TtsConfig::default(),
        mcp: quantclaw_config::schema::McpConfig::default(),
        nodes: quantclaw_config::schema::NodesConfig::default(),
        workspace: quantclaw_config::schema::WorkspaceConfig::default(),
        notion: quantclaw_config::schema::NotionConfig::default(),
        jira: quantclaw_config::schema::JiraConfig::default(),
        node_transport: quantclaw_config::schema::NodeTransportConfig::default(),
        knowledge: quantclaw_config::schema::KnowledgeConfig::default(),
        linkedin: quantclaw_config::schema::LinkedInConfig::default(),
        image_gen: quantclaw_config::schema::ImageGenConfig::default(),
        plugins: quantclaw_config::schema::PluginsConfig::default(),
        locale: None,
        verifiable_intent: quantclaw_config::schema::VerifiableIntentConfig::default(),
        claude_code: quantclaw_config::schema::ClaudeCodeConfig::default(),
        claude_code_runner: quantclaw_config::schema::ClaudeCodeRunnerConfig::default(),
        codex_cli: quantclaw_config::schema::CodexCliConfig::default(),
        gemini_cli: quantclaw_config::schema::GeminiCliConfig::default(),
        opencode_cli: quantclaw_config::schema::OpenCodeCliConfig::default(),
        sop: quantclaw_config::schema::SopConfig::default(),
        shell_tool: quantclaw_config::schema::ShellToolConfig::default(),
    };
    ...
    if has_channels && config.api_key.is_some() {
        ...
        if launch {
            ...
            unsafe { std::env::set_var("QUANTCLAW_AUTOSTART_CHANNELS", "1") };
        }
    }
...
pub async fn run_channels_repair_wizard(callbacks: WizardCallbacks) -> Result<Config> {
    ...
    print_step(1, 1, "Channels (How You Talk to QuantClaw)");
...
/// Use `quantclaw onboard` or `quantclaw onboard --api-key sk-... --provider openrouter --memory sqlite|lucid`.
...
fn memory_config_defaults_for_backend(backend: &str) -> MemoryConfig {
    ...
    MemoryConfig {
        ...
        vector_weight: 0.7,
        keyword_weight: 0.3,
        search_mode: quantclaw_config::schema::SearchMode::default(),
        ...
        policy: quantclaw_config::schema::MemoryPolicyConfig::default(),
        sqlite_open_timeout_secs: None,
        qdrant: quantclaw_config::schema::QdrantConfig::default(),
    }
}
...
fn resolve_quick_setup_dirs_with_home(home: &Path) -> (PathBuf, PathBuf) {
    if let Ok(custom_config_dir) = std::env::var("QUANTCLAW_CONFIG_DIR") {
    ...
    if let Ok(custom_workspace) = std::env::var("QUANTCLAW_WORKSPACE") {
        let trimmed = custom_workspace.trim();
        if !trimmed.is_empty() {
            let expanded = shellexpand::tilde(trimmed);
            return quantclaw_config::schema::resolve_config_dir_for_workspace(&PathBuf::from(
                expanded.as_ref(),
            ));
        }
    }
    ...
    // instead of ~/.quantclaw so the Homebrew service finds the same config.
    if let Some(prefix) = std::env::current_exe()
        .ok()
        .as_deref()
        .and_then(homebrew_prefix_for_exe)
    {
        let config_dir = PathBuf::from(prefix).join("var").join("quantclaw");
        return (config_dir.clone(), config_dir.join("workspace"));
    }

    let config_dir = home.join(".quantclaw");
    (config_dir.clone(), config_dir.join("workspace"))
}

fn homebrew_prefix_for_exe(exe: &Path) -> Option<&'static str> {
    let exe = exe.to_string_lossy();
    if exe == "/opt/homebrew/bin/quantclaw"
        || exe.starts_with("/opt/homebrew/Cellar/quantclaw/")
        || exe.starts_with("/opt/homebrew/opt/quantclaw/")
    {
        return Some("/opt/homebrew");
    }

    if exe == "/usr/local/bin/quantclaw"
        || exe.starts_with("/usr/local/Cellar/quantclaw/")
        || exe.starts_with("/usr/local/opt/quantclaw/")
    {
...
fn quick_setup_homebrew_service_note(
    ...
    let service_root = Path::new(prefix).join("var").join("quantclaw");
    ...
    Some(format!(
        "Homebrew service note: `brew services` uses {} (config {}) by default. Your onboarding just wrote {}. If you plan to run QuantClaw as a service, copy or link this workspace first.",
...
async fn run_quick_setup_with_home(
    ...
    let (quantclaw_dir, workspace_dir) = resolve_quick_setup_dirs_with_home(home);
    let config_path = quantclaw_dir.join("config.toml");
    ...
    let config = Config {
        ...
        storage: StorageConfig::default(),
        tunnel: quantclaw_config::schema::TunnelConfig::default(),
        gateway: quantclaw_config::schema::GatewayConfig::default(),
        ...
        swarms: std::collections::HashMap::new(),
        hooks: quantclaw_config::schema::HooksConfig::default(),
        hardware: quantclaw_config::schema::HardwareConfig::default(),
        query_classification: quantclaw_config::schema::QueryClassificationConfig::default(),
        transcription: quantclaw_config::schema::TranscriptionConfig::default(),
        tts: quantclaw_config::schema::TtsConfig::default(),
        mcp: quantclaw_config::schema::McpConfig::default(),
    ...
    if credential_override.is_none() {
        if provider_supports_keyless_local_usage(&provider_name) {
            println!("    1. Chat:     quantclaw agent -m \"Hello!\"");
            println!("    2. Gateway:  quantclaw gateway");
            println!("    3. Status:   quantclaw status");
            ...
            if canonical_provider_name(&provider_name) == "copilot" {
                ...
                println!(
                    "    1. Login:             quantclaw auth login --provider {}",
                    provider_name
                );
                println!("    2. Chat:              quantclaw agent -m \"Hello!\"");
                println!("    3. Gateway:           quantclaw gateway");
                println!("    4. Status:            quantclaw status");
            }
        } else {
            let env_var = provider_env_var(&provider_name);
            println!("    1. Set your API key:  export {env_var}=\"sk-...\"");
            println!("    2. Or edit:           ~/.quantclaw/config.toml");
            println!("    3. Chat:              quantclaw agent -m \"Hello!\"");
            println!("    4. Gateway:           quantclaw gateway");
        }
    } else {
        println!("    1. Chat:     quantclaw agent -m \"Hello!\"");
        println!("    2. Gateway:  quantclaw gateway");
...
pub async fn run_models_refresh(
        ...
        .await?
    {
        ...
        println!();
        println!(
            "Tip: run `quantclaw models refresh --force --provider {}` to fetch latest now.",
            provider_name
        );
        return Ok(());
    }
...
pub async fn run_models_list(config: &Config, provider_override: Option<&str>) -> Result<()> {
    ...
    let Some(cached) = cached else {
        println!();
        println!(
            "  No cached models for '{provider_name}'. Run: quantclaw models refresh --provider {provider_name}"
        );
        println!();
        return Ok(());
    };
...
pub async fn run_models_refresh_all(config: &Config, force: bool) -> Result<()> {
    let mut targets: Vec<String> = quantclaw_providers::list_providers()
        .into_iter()
...
async fn persist_workspace_selection(config_path: &Path) -> Result<()> {
    ...
    quantclaw_config::schema::persist_active_workspace_config_dir(config_dir)
        .await
        .with_context(|| {
            format!(
...
async fn setup_workspace() -> Result<(PathBuf, PathBuf)> {
    let (default_config_dir, default_workspace_dir) =
        quantclaw_config::schema::resolve_runtime_dirs_for_onboarding().await?;
    ...
    let (config_dir, workspace_dir) = if use_default {
        ...
        quantclaw_config::schema::resolve_config_dir_for_workspace(&PathBuf::from(expanded))
    };
...
async fn setup_provider(workspace_dir: &Path) -> Result<(String, String, String, Option<String>)> {
    ...
    if providers.is_empty() {
        ...
        print_bullet("QuantClaw works with ANY API that speaks the OpenAI chat completions format.");
    ...
    let api_key = if provider_name == "ollama" {
        ...
        if quantclaw_providers::gemini::GeminiProvider::has_cli_credentials() {
            print_bullet(&format!(
                "{} Gemini CLI credentials detected! You can skip the API key.",
                style("✓").green().bold()
            ));
            print_bullet("QuantClaw will reuse your existing Gemini CLI authentication.");
            println!();
...
fn setup_tool_mode() -> Result<(ComposioConfig, SecretsConfig)> {
    print_bullet("Choose how QuantClaw connects to external apps.");
    ...
    let composio_config = if choice == 1 {
        ...
        print_bullet("QuantClaw uses Composio as a tool — your core agent stays local.");
        println!();
    ...
    // ── Encrypted secrets ──
    println!();
    print_bullet("QuantClaw can encrypt API keys stored in config.toml.");
...
fn setup_memory() -> Result<MemoryConfig> {
    print_bullet("Choose how QuantClaw stores and searches memories.");
    print_bullet("You can always change this later in config.toml.");
    println!();
...
fn setup_channels(
    ...
    print_bullet("Channels let you talk to QuantClaw from anywhere.");
        ...
        match choice {
            ChannelMenuChoice::Telegram => {
                ...
                println!(
                    ...
                    style("— talk to QuantClaw from Telegram").dim()
                );
            ...
            ChannelMenuChoice::Discord => {
                ...
                println!(
                    ...
                    style("— talk to QuantClaw from Discord").dim()
                );
            ...
            ChannelMenuChoice::Slack => {
                ...
                println!(
                    ...
                    style("— talk to QuantClaw from Slack").dim()
                );
            ...
            ChannelMenuChoice::IMessage => {
                ...
                print_bullet("QuantClaw reads your iMessage database and replies via AppleScript.");
                print_bullet(
            ...
            ChannelMenuChoice::WhatsApp => {
                ...
                if mode_idx == 0 {
                    ...
                    let session_path: String = Input::new()
                        ...
                        .default("~/.quantclaw/state/whatsapp-web/session.db")
                        .interact_text()?;
                ...
                let verify_token: String = Input::new()
                    ...
                    .default("quantclaw-whatsapp-verify")
                    .interact_text()?;
            ...
            ChannelMenuChoice::Lark | ChannelMenuChoice::Feishu => {
                ...
                println!(
                    ...
                    style(format!("— talk to QuantClaw from {provider_label}")).dim()
                );
                print_bullet(&format!(
            ...
            ChannelMenuChoice::Nostr => {
                ...
                print_bullet("QuantClaw will listen for encrypted DMs on Nostr relays.");
                ...
                // Validate the key via callback (requires nostr-sdk in quantclaw-channels)
...
#[allow(clippy::too_many_lines)]
fn setup_tunnel() -> Result<quantclaw_config::schema::TunnelConfig> {
    use quantclaw_config::schema::{
...
fn print_summary(config: &Config) {
    ...
    println!(
        "  {}  {}",
        style("⚡").cyan(),
        style("QuantClaw is ready!").white().bold()
    );
    println!(
        "  {}",
        style("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━").cyan()
    ...
    if config.api_key.is_none() && !provider_supports_keyless_local_usage(provider) {
        if provider == "openai-codex" {
            ...
            println!(
                "       {}",
                style("quantclaw auth login --provider openai-codex --device-code").yellow()
            );
            ...
            println!(
                "       {}",
                style(
                    "or: quantclaw auth paste-token --provider anthropic --auth-kind authorization"
                )
                .yellow()
            );
        } else {
    ...
    if has_channels {
        ...
        println!("       {}", style("quantclaw channel start").yellow());
        println!();
        step += 1;
    }
    ...
    println!(
        "       {}",
        style("quantclaw agent -m \"Hello, QuantClaw!\"").yellow()
    );
    println!();
    step += 1;
    ...
    println!("       {}", style("quantclaw agent").yellow());
    println!();
    step += 1;
    ...
    println!("       {}", style("quantclaw status").yellow());
...
mod tests {
    ...
    async fn quick_setup_model_override_persists_to_config_toml() {
        ...
        let _workspace_env = EnvVarGuard::unset("QUANTCLAW_WORKSPACE");
        let _config_env = EnvVarGuard::unset("QUANTCLAW_CONFIG_DIR");
    ...
    async fn quick_setup_existing_config_requires_force_when_non_interactive() {
        ...
        let _config_env = EnvVarGuard::unset("QUANTCLAW_CONFIG_DIR");
        let tmp = TempDir::new().unwrap();
        let quantclaw_dir = tmp.path().join(".quantclaw");
        let config_path = quantclaw_dir.join("config.toml");

        tokio::fs::create_dir_all(&quantclaw_dir).await.unwrap();
    ...
    #[tokio::test]
    async fn quick_setup_respects_quant_claw_workspace_env_layout() {
        let _env_guard = env_lock().lock().await;
        let tmp = TempDir::new().unwrap();
        let workspace_root = tmp.path().join("quantclaw-data");
        let workspace_dir = workspace_root.join("workspace");
        let expected_config_path = workspace_root.join(".quantclaw").join("config.toml");
        ...
        .await
        .expect("quick setup should honor QUANTCLAW_WORKSPACE");
    ...
    fn homebrew_prefix_for_exe_detects_supported_layouts() {
        assert_eq!(
            homebrew_prefix_for_exe(Path::new("/opt/homebrew/bin/quantclaw")),
            Some("/opt/homebrew")
        );
        assert_eq!(
            homebrew_prefix_for_exe(Path::new(
                "/opt/homebrew/Cellar/quantclaw/0.5.0/bin/quantclaw",
            )),
            Some("/opt/homebrew")
        );
        assert_eq!(
            homebrew_prefix_for_exe(Path::new("/usr/local/bin/quantclaw")),
            Some("/usr/local")
        );
        assert_eq!(homebrew_prefix_for_exe(Path::new("/tmp/quantclaw")), None);
    }

    #[test]
    fn quick_setup_homebrew_service_note_mentions_service_workspace() {
        let note = quick_setup_homebrew_service_note(
            Path::new("/Users/alix/.quantclaw/config.toml"),
            Path::new("/Users/alix/.quantclaw/workspace"),
            Path::new("/opt/homebrew/bin/quantclaw"),
        )
        .expect("homebrew installs should emit a service workspace note");

        assert!(note.contains("/opt/homebrew/var/quantclaw/workspace"));
        assert!(note.contains("/opt/homebrew/var/quantclaw/config.toml"));
        assert!(note.contains("/Users/alix/.quantclaw/config.toml"));
    }

    #[test]
    fn quick_setup_homebrew_service_note_skips_matching_service_layout() {
        let service_config = Path::new("/opt/homebrew/var/quantclaw/config.toml");
        let service_workspace = Path::new("/opt/homebrew/var/quantclaw/workspace");
    ...
    async fn scaffold_uses_defaults_for_empty_context() {
        ...
        let identity = tokio::fs::read_to_string(tmp.path().join("IDENTITY.md"))
            ...
            .unwrap();
        assert!(
            identity.contains("**Name:** QuantClaw"),
            "should default agent name to QuantClaw"
        );
    ...
    async fn scaffold_handles_special_characters_in_names() {
        ...
        let soul = tokio::fs::read_to_string(tmp.path().join("SOUL.md"))
            .await
            .unwrap();
        assert!(soul.contains("QuantClaw-v2"));
    }
    ...
    fn launchable_channels_include_signal_mattermost_qq_nextcloud_and_feishu() {
        ...
        channels.signal = Some(quantclaw_config::schema::SignalConfig {
            enabled: true,
        ...
        channels.mattermost = Some(quantclaw_config::schema::MattermostConfig {
            enabled: true,
        ...
        channels.qq = Some(quantclaw_config::schema::QQConfig {
            enabled: true,
            app_id: "app-id".into(),
        ...
        channels.qq = None;
        channels.nextcloud_talk = Some(quantclaw_config::schema::NextcloudTalkConfig {
            enabled: true,
        ...
        channels.feishu = Some(quantclaw_config::schema::FeishuConfig {
            enabled: true,
            app_id: "cli_123".into(),
            ...
            allowed_users: vec!["*".into()],
            receive_mode: quantclaw_config::schema::LarkReceiveMode::Websocket,
            port: None,
            proxy_url: None,
        });
        assert!(has_launchable_channels(&channels));
    ...
    fn channels_repair_preserves_unmodified_channels() {
        use quantclaw_config::schema::{DiscordConfig, MatrixConfig, StreamMode};
    ...
    fn matrix_reconfigure_preserves_non_prompted_fields() {
        use quantclaw_config::schema::{MatrixConfig, StreamMode};
    ...
    fn matrix_fresh_install_uses_defaults_for_non_prompted_fields() {
        use quantclaw_config::schema::StreamMode;

        let existing_mx: Option<&quantclaw_config::schema::MatrixConfig> = None;
