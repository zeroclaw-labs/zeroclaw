...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/daemonclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to DaemonClaw tool names.
...
/// to. This function encodes the mapping for known DaemonClaw tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. DaemonClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
...
Let me check the result."#;
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Additional parser internals tests (moved from daemonclaw-runtime to keep
