//! Plugin manifest — `~/.quantclaw/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how QuantClaw spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, QuantClaw will prefer the named transport kind
