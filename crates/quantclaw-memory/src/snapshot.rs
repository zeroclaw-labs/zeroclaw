...
const SNAPSHOT_HEADER: &str = "# 🧠 QuantClaw Memory Snapshot\n\n\
    > Auto-generated by QuantClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 QuantClaw Memory Snapshot

> Auto-generated by QuantClaw.
...
I am QuantClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 QuantClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
