...
const SNAPSHOT_HEADER: &str = "# 🧠 DaemonClaw Memory Snapshot\n\n\
    > Auto-generated by DaemonClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 DaemonClaw Memory Snapshot

> Auto-generated by DaemonClaw.
...
I am DaemonClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 DaemonClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
