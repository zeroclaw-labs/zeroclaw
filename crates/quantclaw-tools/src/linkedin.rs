...
use quantclaw_config::schema::{LinkedInContentConfig, LinkedInImageConfig};
...
mod tests {
    ...
    async fn get_content_strategy_returns_config() {
        let content = LinkedInContentConfig {
            ...
            github_repos: vec!["quant-speed/quantclaw".into()],
        ...
        assert!(result.output.contains("quant-speed/quantclaw"));
