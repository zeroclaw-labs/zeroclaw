...
use quantclaw_config::schema::{DelegateAgentConfig, SwarmConfig, SwarmStrategy};
...
impl SwarmTool {
    ...
    fn create_provider_for_agent(
        ...
        quantclaw_providers::create_provider_with_options(
    ...
    async fn execute_parallel(
        ...
        for agent_name in &swarm_config.agents {
            ...
            let provider = match quantclaw_providers::create_provider_with_options(
                &agent_config.provider,
                credential.as_deref(),
                &self.provider_runtime_options,
            ) {
