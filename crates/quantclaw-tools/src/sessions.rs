...
use quantclaw_infra::session_backend::SessionBackend;
...
impl Tool for SessionsSendTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let chat_msg = quantclaw_api::provider::ChatMessage::user(message);
...
mod tests {
    ...
    use quantclaw_api::provider::ChatMessage;
    use quantclaw_infra::session_store::SessionStore;
