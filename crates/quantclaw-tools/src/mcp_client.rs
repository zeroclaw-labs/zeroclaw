...
use quantclaw_config::schema::McpServerConfig;
...
mod tests {
    use super::*;
    use quantclaw_config::schema::McpTransport;
    ...
    async fn connect_nonexistent_command_fails_cleanly() {
        ...
        let config = McpServerConfig {
            ...
            command: "/usr/bin/this_binary_does_not_exist_quantclaw_test".to_string(),
            args: vec![],
