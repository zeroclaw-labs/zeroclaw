...
use quantclaw_config::schema::ClaudeCodeRunnerConfig;
...
/// execution events back to QuantClaw's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the QuantClaw gateway (e.g. "http://localhost:3000").
    gateway_url: String,
}
