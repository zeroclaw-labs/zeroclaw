...
use daemonclaw_config::policy::ToolOperation;
use daemonclaw_config::schema::ClaudeCodeRunnerConfig;
...
/// execution events back to DaemonClaw's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the DaemonClaw gateway (e.g. "http://localhost:3000").
    gateway_url: String,
}
