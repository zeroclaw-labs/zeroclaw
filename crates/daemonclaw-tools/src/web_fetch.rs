...
use daemonclaw_config::schema::FirecrawlConfig;
...
impl Tool for WebFetchTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let builder = reqwest::Client::builder()
            ...
            .user_agent("DaemonClaw/0.1 (web_fetch)");
        let builder =
            daemonclaw_config::schema::apply_runtime_proxy_to_builder(builder, "tool.web_fetch");
...
mod tests {
    ...
    fn firecrawl_config_defaults() {
        ...
        assert_eq!(cfg.mode, daemonclaw_config::schema::FirecrawlMode::Scrape);
    }
    ...
    fn firecrawl_config_deserializes_from_toml() {
        ...
        assert_eq!(cfg.mode, daemonclaw_config::schema::FirecrawlMode::Crawl);
    }
    ...
    fn web_fetch_config_with_firecrawl_section() {
        use daemonclaw_config::schema::WebFetchConfig;
        let toml_str = r#"
            enabled = true
            [firecrawl]
            enabled = true
