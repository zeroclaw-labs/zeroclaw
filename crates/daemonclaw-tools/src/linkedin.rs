...
use daemonclaw_config::schema::{LinkedInContentConfig, LinkedInImageConfig};
...
mod tests {
    ...
    async fn get_content_strategy_returns_config() {
        let content = LinkedInContentConfig {
            ...
            github_repos: vec!["DeliveryBoyTech/daemonclaw".into()],
        ...
        assert!(result.output.contains("DeliveryBoyTech/daemonclaw"));
