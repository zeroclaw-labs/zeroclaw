...
use daemonclaw_config::schema::{LineDmPolicy, LineGroupPolicy};
...
impl LineChannel {
    ...
    pub fn new(
        ...
        Self {
            ...
            client: daemonclaw_config::schema::build_channel_proxy_client("channel.line", None),
    ...
    /// Construct a `LineChannel` directly from a [`daemonclaw_config::schema::LineConfig`].
    ///
    ...
    pub fn from_config(config: &daemonclaw_config::schema::LineConfig) -> Self {
        Self::new(
    ...
    pub fn with_proxy_url(mut self, proxy_url: Option<String>) -> Self {
        self.client = daemonclaw_config::schema::build_channel_proxy_client(
            "channel.line",
            proxy_url.as_deref(),
        );
        self
...
mod tests {
    ...
    async fn webhook_audio_transcribed_and_forwarded() {
        ...
        let transcription_config = daemonclaw_config::schema::TranscriptionConfig {
            enabled: true,
