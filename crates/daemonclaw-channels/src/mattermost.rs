...
mod tests {
    ...
    fn mattermost_manager_some_when_valid_config() {
        let ch = make_channel(vec!["*".into()], false).with_transcription(
            daemonclaw_config::schema::TranscriptionConfig {
                enabled: true,
    ...
    mod http_tests {
        ...
        async fn mattermost_audio_routes_through_local_whisper() {
            ...
            .with_transcription(daemonclaw_config::schema::TranscriptionConfig {
                enabled: true,
                ...
                assemblyai: None,
                google: None,
                local_whisper: Some(daemonclaw_config::schema::LocalWhisperConfig {
                    url: whisper_url,
