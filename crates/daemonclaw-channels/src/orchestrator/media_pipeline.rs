...
use daemonclaw_config::schema::{MediaPipelineConfig, TranscriptionConfig};

// Re-export media types from daemonclaw-types for backwards compatibility.
pub use daemonclaw_api::media::{MediaAttachment, MediaKind};
