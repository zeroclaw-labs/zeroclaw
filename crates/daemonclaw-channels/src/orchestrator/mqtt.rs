...
use daemonclaw_config::schema::MqttConfig;
use daemonclaw_runtime::sop::audit::SopAuditLogger;
use daemonclaw_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use daemonclaw_runtime::sop::engine::{SopEngine, now_iso8601};
use daemonclaw_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    daemonclaw_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                daemonclaw_runtime::health::mark_component_error("mqtt", e.to_string());
