...
use quantclaw_config::schema::{MediaPipelineConfig, TranscriptionConfig};

// Re-export media types from quantclaw-types for backwards compatibility.
pub use quantclaw_api::media::{MediaAttachment, MediaKind};
