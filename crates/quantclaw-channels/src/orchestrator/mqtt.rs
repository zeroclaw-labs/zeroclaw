...
use quantclaw_config::schema::MqttConfig;
use quantclaw_runtime::sop::audit::SopAuditLogger;
use quantclaw_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use quantclaw_runtime::sop::engine::{SopEngine, now_iso8601};
use quantclaw_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    quantclaw_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                quantclaw_runtime::health::mark_component_error("mqtt", e.to_string());
