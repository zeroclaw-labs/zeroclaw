...
use quantclaw_config::schema::TranscriptionConfig;
...
impl TranscriptionProvider for GroqProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = quantclaw_config::schema::build_runtime_proxy_client("transcription.groq");
...
impl OpenAiWhisperProvider {
    pub fn from_config(config: &quantclaw_config::schema::OpenAiSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for OpenAiWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = quantclaw_config::schema::build_runtime_proxy_client("transcription.openai");
...
impl DeepgramProvider {
    pub fn from_config(config: &quantclaw_config::schema::DeepgramSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for DeepgramProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = quantclaw_config::schema::build_runtime_proxy_client("transcription.deepgram");
...
impl AssemblyAiProvider {
    pub fn from_config(config: &quantclaw_config::schema::AssemblyAiSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for AssemblyAiProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            quantclaw_config::schema::build_runtime_proxy_client("transcription.assemblyai");
...
impl GoogleSttProvider {
    pub fn from_config(config: &quantclaw_config::schema::GoogleSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for GoogleSttProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = quantclaw_config::schema::build_runtime_proxy_client("transcription.google");
...
impl LocalWhisperProvider {
    ...
    pub fn from_config(config: &quantclaw_config::schema::LocalWhisperConfig) -> Result<Self> {
...
impl TranscriptionProvider for LocalWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            quantclaw_config::schema::build_runtime_proxy_client("transcription.local_whisper");
...
mod tests {
    ...
    async fn openai_default_provider_uses_openai_config() {
        ...
        let config = TranscriptionConfig {
            ...
            openai: Some(quantclaw_config::schema::OpenAiSttConfig {
                api_key: None,
    ...
    fn manager_registers_multiple_providers() {
        ...
        let config = TranscriptionConfig {
            ...
            deepgram: Some(quantclaw_config::schema::DeepgramSttConfig {
    ...
    fn local_whisper_config(url: &str) -> quantclaw_config::schema::LocalWhisperConfig {
        quantclaw_config::schema::LocalWhisperConfig {
            url: url.to_string(),
