...
pub use quantclaw_config::scattered_types::EmailConfig;
...
impl EmailChannel {
    ...
    fn extract_attachments(
    ...
    ) -> Vec<quantclaw_api::media::MediaAttachment> {
        ...
        for part in parsed.attachments() {
            ...
            attachments.push(quantclaw_api::media::MediaAttachment {
                file_name,
                data,
                mime_type: mime_str,
            });
...
struct ParsedEmail {
    ...
    content: String,
    timestamp: u64,
    attachments: Vec<quantclaw_api::media::MediaAttachment>,
}
...
mod tests {
    ...
    fn email_config_deserialize_with_defaults() {
        ...
        assert_eq!(config.default_subject, "QuantClaw Message"); // default
    }
