...
impl Channel for DiscordChannel {
    ...
    async fn send(&self, message: &SendMessage) -> anyhow::Result<()> {
        ...
        if self.stream_mode == quantclaw_config::schema::StreamMode::MultiMessage {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        ...
        let watchdog = if self.stall_timeout_secs > 0 {
            Some(quantclaw_infra::stall_watchdog::StallWatchdog::new(
    ...
    fn supports_multi_message_streaming(&self) -> bool {
        self.stream_mode == quantclaw_config::schema::StreamMode::MultiMessage
    }
...
mod tests {
    ...
    async fn send_draft_returns_none_when_not_partial() {
        use quantclaw_api::channel::SendMessage;
        use quantclaw_config::schema::StreamMode;
