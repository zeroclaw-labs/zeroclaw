...
pub struct SessionActorQueue {
    ...
    transcript_generations: std::sync::Mutex<HashMap<String, u64>>,
...
impl SessionActorQueue {
    ...
    pub fn new(max_queue_depth: usize, lock_timeout_secs: u64, idle_ttl_secs: u64) -> Self {
        Self {
            ...
            transcript_generations: std::sync::Mutex::new(HashMap::new()),
    ...
    pub fn transcript_generation(&self, session_id: &str) -> u64 {
    ...
    pub fn advance_generation(&self, session_id: &str) -> u64 {
        ...
        if let Ok(mut map) = self.transcript_generations.lock() {
