...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/quantclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to QuantClaw tool names.
...
/// to. This function encodes the mapping for known QuantClaw tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. QuantClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
