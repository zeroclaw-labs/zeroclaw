...
pub fn parse_pin_aliases(content: &str) -> PinAliases {
...
pub fn infer_board_from_path(path: &Path, base: &Path) -> Option<String> {
...
mod tests {
    ...
    #[test]
    pub fn parse_pin_aliases_key_value() {
...
user_led: 5"#;
    ...
    #[test]
    pub fn parse_pin_aliases_table() {
        let md = r#"## Pin Aliases
| alias | pin |
|-------|-----|
| red_led | 13 |
| builtin_led | 13 |"#;
    ...
    #[test]
    pub fn parse_pin_aliases_empty() {
        let a = parse_pin_aliases("No aliases here");
        assert!(a.is_empty());
    }

    #[test]
    pub fn infer_board_from_path_nucleo() {
