...
mod tests {
    ...
    use daemonclaw_config::schema::{IMessageConfig, MatrixConfig, StreamMode, TelegramConfig};
    ...
    fn regional_provider_aliases_activate_expected_ai_integrations() {
        ...
        // Init a temp provider store for tests.
        let tmp = tempfile::tempdir().unwrap();
        let _ = daemonclaw_config::provider_store::init_provider_store(tmp.path(), tmp.path(), false);
        let store = daemonclaw_config::provider_store::provider_store();

        store.set_fallback_name("minimax-cn").unwrap();
        ...
        store.set_fallback_name("glm-cn").unwrap();
        ...
        store.set_fallback_name("moonshot-intl").unwrap();
        ...
        store.set_fallback_name("qwen-intl").unwrap();
        ...
        store.set_fallback_name("zai-cn").unwrap();
        ...
        store.set_fallback_name("baidu").unwrap();
