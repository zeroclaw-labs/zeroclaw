...
impl OtelObserver {
    ...
    pub fn new(
        ...
        let service_name = service_name.unwrap_or("daemonclaw");
...
impl Observer for OtelObserver {
    fn record_event(&self, event: &ObserverEvent) {
        let tracer = global::tracer("daemonclaw");
...
mod tests {
    ...
    fn test_observer() -> OtelObserver {
        ...
        OtelObserver::new(Some("http://127.0.0.1:19999"), Some("daemonclaw-test"), None)
    ...
    fn otel_observer_creation_with_valid_endpoint_succeeds() {
        ...
        let result = OtelObserver::new(Some("http://127.0.0.1:12345"), Some("daemonclaw-test"), None);
        assert!(
            result.is_ok(),
