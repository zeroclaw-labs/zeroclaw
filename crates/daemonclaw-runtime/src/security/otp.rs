...
use daemonclaw_config::schema::OtpConfig;

const OTP_SECRET_FILE: &str = "otp-secret";
const OTP_DIGITS: u32 = 6;
const OTP_ISSUER: &str = "DaemonClaw";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(daemonclaw_dir);
...
pub fn secret_file_path(daemonclaw_dir: &Path) -> PathBuf {
    daemonclaw_dir.join(OTP_SECRET_FILE)
}
