...
pub use daemonclaw_tools::ask_user::AskUserTool;
pub use daemonclaw_tools::ask_user::ChannelMapHandle;
pub use daemonclaw_tools::backup_tool::BackupTool;
pub use daemonclaw_tools::browser::{BrowserTool, ComputerUseConfig};
pub use daemonclaw_tools::browser_delegate::BrowserDelegateTool;
pub use daemonclaw_tools::browser_open::BrowserOpenTool;
pub use daemonclaw_tools::calculator::CalculatorTool;
pub use daemonclaw_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use daemonclaw_tools::canvas::{CanvasStore, CanvasTool};
pub use daemonclaw_tools::claude_code::ClaudeCodeTool;
pub use daemonclaw_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use daemonclaw_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use daemonclaw_tools::cloud_ops::CloudOpsTool;
pub use daemonclaw_tools::cloud_patterns::CloudPatternsTool;
pub use daemonclaw_tools::codex_cli::CodexCliTool;
pub use daemonclaw_tools::composio::ComposioTool;
pub use daemonclaw_tools::content_search::ContentSearchTool;
pub use daemonclaw_tools::data_management::DataManagementTool;
pub use daemonclaw_tools::discord_search::DiscordSearchTool;
pub use daemonclaw_tools::escalate::EscalateToHumanTool;
pub use daemonclaw_tools::file_edit::FileEditTool;
pub use daemonclaw_tools::file_write::FileWriteTool;
pub use daemonclaw_tools::gemini_cli::GeminiCliTool;
pub use daemonclaw_tools::git_operations::GitOperationsTool;
pub use daemonclaw_tools::glob_search::GlobSearchTool;
pub use daemonclaw_tools::google_workspace::GoogleWorkspaceTool;
pub use daemonclaw_tools::hardware_board_info::HardwareBoardInfoTool;
pub use daemonclaw_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use daemonclaw_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use daemonclaw_tools::http_request::HttpRequestTool;
pub use daemonclaw_tools::image_gen::ImageGenTool;
pub use daemonclaw_tools::image_info::ImageInfoTool;
pub use daemonclaw_tools::jira_tool::JiraTool;
pub use daemonclaw_tools::knowledge_tool::KnowledgeTool;
pub use daemonclaw_tools::linkedin::LinkedInTool;
pub use daemonclaw_tools::llm_task::LlmTaskTool;
pub use daemonclaw_tools::mcp_client::McpRegistry;
pub use daemonclaw_tools::mcp_deferred::{
    ActivatedToolSet, DeferredMcpToolSet, build_deferred_tools_section,
};
pub use daemonclaw_tools::mcp_tool::McpToolWrapper;
pub use daemonclaw_tools::memory_export::MemoryExportTool;
pub use daemonclaw_tools::memory_forget::MemoryForgetTool;
pub use daemonclaw_tools::memory_purge::MemoryPurgeTool;
pub use daemonclaw_tools::memory_recall::MemoryRecallTool;
pub use daemonclaw_tools::memory_store::MemoryStoreTool;
pub use daemonclaw_tools::microsoft365::Microsoft365Tool;
pub use daemonclaw_tools::model_routing_config::ModelRoutingConfigTool;
pub use daemonclaw_tools::notion_tool::NotionTool;
pub use daemonclaw_tools::opencode_cli::OpenCodeCliTool;
#[cfg(feature = "rag-pdf")]
pub use daemonclaw_tools::pdf_read::PdfReadTool;
pub use daemonclaw_tools::pipeline::PipelineTool;
pub use daemonclaw_tools::poll::PollTool;
pub use daemonclaw_tools::project_intel::ProjectIntelTool;
pub use daemonclaw_tools::proxy_config::ProxyConfigTool;
pub use daemonclaw_tools::pushover::PushoverTool;
pub use daemonclaw_tools::reaction::ReactionTool;
pub use daemonclaw_tools::report_template_tool::ReportTemplateTool;
pub use daemonclaw_tools::screenshot::ScreenshotTool;
pub use daemonclaw_tools::sessions::{SessionsHistoryTool, SessionsListTool, SessionsSendTool};
pub use daemonclaw_tools::swarm::SwarmTool;
pub use daemonclaw_tools::text_browser::TextBrowserTool;
pub use daemonclaw_tools::tool_search::ToolSearchTool;
pub use daemonclaw_tools::weather_tool::WeatherTool;
pub use daemonclaw_tools::web_fetch::WebFetchTool;
pub use daemonclaw_tools::web_search_tool::WebSearchTool;
pub use daemonclaw_tools::workspace_tool::WorkspaceTool;
pub use daemonclaw_tools::wrappers::{PathGuardedTool, RateLimitedTool};

// Traits from daemonclaw-api
pub use daemonclaw_api::schema::{CleaningStrategy, SchemaCleanr};
pub use daemonclaw_api::tool::{Tool, ToolResult, ToolSpec};
...
use std::sync::Arc;
use daemonclaw_config::schema::{Config, DelegateAgentConfig};
use daemonclaw_memory::Memory;
...
pub fn all_tools(
    ...
    browser_config: &daemonclaw_config::schema::BrowserConfig,
    http_config: &daemonclaw_config::schema::HttpRequestConfig,
    web_fetch_config: &daemonclaw_config::schema::WebFetchConfig,
...
pub fn all_tools_with_runtime(
    ...
    if root_config.channels.discord_history.is_some() {
        match daemonclaw_memory::SqliteMemory::new_named(workspace_dir, "discord") {
            Ok(discord_mem) => {
    ...
    if matches!(
        ...
        daemonclaw_config::schema::SkillsPromptInjectionMode::Compact
    ) {
    ...
    if let Ok(session_store) = daemonclaw_infra::session_store::SessionStore::new(workspace_dir) {
        let backend: Arc<dyn daemonclaw_infra::session_backend::SessionBackend> =
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = daemonclaw_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match daemonclaw_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    if root_config.workspace.enabled {
        ...
        let ws_manager = daemonclaw_config::workspace::WorkspaceManager::new(workspaces_dir);
    ...
    #[cfg(feature = "plugins-wasm")]
    {
        ...
        if plugin_path.exists() && config.plugins.enabled {
            match daemonclaw_plugins::host::PluginHost::new(
                ...
                Ok(host) => {
                    ...
                    for (manifest, wasm_path) in details {
                        tool_arcs.push(Arc::new(daemonclaw_plugins::wasm_tool::WasmTool::from_wasm(
...
mod tests {
    ...
    use daemonclaw_config::schema::{BrowserConfig, Config, MemoryConfig};
    ...
    fn all_tools_excludes_browser_when_disabled() {
        ...
        let mem: Arc<dyn Memory> =
            Arc::from(daemonclaw_memory::create_memory(&mem_cfg, tmp.path(), None).unwrap());
        ...
        let http = daemonclaw_config::schema::HttpRequestConfig::default();
        ...
        let (tools, _, _, _, _, _) = all_tools(
            ...
            &browser,
            &http,
            &daemonclaw_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &cfg,
    ...
    fn all_tools_excludes_read_skill_in_full_mode() {
        ...
        let http = daemonclaw_config::schema::HttpRequestConfig::default();
        let mut cfg = test_config(&tmp);
        cfg.skills.prompt_injection_mode = daemonclaw_config::schema::SkillsPromptInjectionMode::Full;
