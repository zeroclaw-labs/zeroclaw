...
pub fn build_system_prompt_with_mode(
    ...
    let autonomy_cfg = daemonclaw_config::schema::AutonomyConfig {
...
pub fn build_system_prompt_with_mode_and_autonomy(
    ...
    identity_config: Option<&daemonclaw_config::schema::IdentityConfig>,
    bootstrap_max_chars: Option<usize>,
    autonomy_config: Option<&daemonclaw_config::schema::AutonomyConfig>,
    native_tools: bool,
    skills_prompt_mode: daemonclaw_config::schema::SkillsPromptInjectionMode,
    ...
    if prompt.is_empty() {
        "You are DaemonClaw, a fast and efficient AI assistant built in Rust. Be helpful, concise, and direct."
            .to_string()
    } else {
        prompt
    }
