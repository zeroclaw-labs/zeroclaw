//! # DaemonClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with DaemonClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  DaemonClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use daemonclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of DaemonClaw. It defines its own
//! `Tool` trait that is compatible with DaemonClaw's but doesn't require it.
//!
//! ## Safety
//!
