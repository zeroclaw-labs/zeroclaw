...
mod tests {
    ...
    // Arc<ModelAwareMock> Provider impl provided by blanket impl in daemonclaw-types.
    ...
    // Arc<NativeModelAwareMock> Provider impl provided by blanket impl in daemonclaw-types.
    ...
    // Arc<StreamingToolEventMock> Provider impl provided by blanket impl in daemonclaw-types.
