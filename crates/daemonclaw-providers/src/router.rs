...
mod tests {
    ...
    // Arc<MockProvider> Provider impl provided by blanket impl in daemonclaw-types.
    ...
    // Arc<StreamingMockProvider> Provider impl provided by blanket impl in daemonclaw-types.
    ...
    // Arc<ToolEventStreamingMockProvider> Provider impl provided by blanket impl in daemonclaw-types.
