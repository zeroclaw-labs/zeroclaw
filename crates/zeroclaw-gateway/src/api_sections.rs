...
pub async fn handle_section_select(
    ...
    let (fields_prefix, created) = match section_enum {
        ...
        Section::Storage => {
            ...
            // transcription_providers. Outer bucket is the authoritative
            // storage kind; inner key is the operator-named alias.
            let created = working
...
mod tests {
    ...
    /// surfaces the real storage kinds (sqlite, postgres, qdrant, markdown)
    /// regardless of which aliases exist, and badges
