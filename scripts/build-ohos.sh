...
if [[ -z "${OHOS_NDK_HOME}" ]]; then
    if [[ -d "/mnt/d/tools/commandline-tools/sdk/default/openharmony/native" ]]; then
        ...
        echo "  - /mnt/d/tools/commandline-tools/sdk/default/openharmony/native (WSL2)"
        echo "  - D:/tools/commandline-tools-windows/sdk/default/openharmony/native (Windows)"
        echo "  - /opt/commandline-tools/sdk/default/openharmony/native (Linux)"
        echo "  - \$HOME/commandline-tools/sdk/default/openharmony/native (User home)"
        echo ""
        echo "Example: export OHOS_NDK_HOME=/path/to/commandline-tools/sdk/default/openharmony/native"
        exit 1
    fi
fi
