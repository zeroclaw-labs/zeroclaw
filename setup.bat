...
echo   %GREEN%OK%RESET% Binary installed to %USERPROFILE%\.quantclaw\bin\quantclaw.exe
goto :post_install
...
echo     2. Run: quantclaw init
echo     3. Configure your API key in %%USERPROFILE%%\.quantclaw\config.toml
echo.
